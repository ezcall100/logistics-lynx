              ...
              >
                {[
                  ...
                  >
                    ...
                    <div>
                      <div className="text-white font-semibold text-sm responsive-container">
                        {item.text}
                      </div>
                      <div className="text-cyan-400 font-bold text-lg responsive-container">
                        {item.metric}
                      </div>
                    </div>
                  </motion.div>
                ...
                <div className="flex items-center gap-3 responsive-container">
                  <div className="flex responsive-container">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        key={i}
                        className="w-5 h-5 text-yellow-400 fill-current responsive-container"
                      />
                    ))}
                  </div>
                  <div>
            ...
            >
              <div className="relative responsive-container">
                ...
                <div className="w-96 h-96 relative responsive-container">
                  ...
                  {[
                    {
                      icon: <Truck className="w-6 h-6 responsive-container" />,
                      color: 'blue',
                      delay: 0,
                    },
                    {
                    ...
                    {
                      icon: <Users className="w-6 h-6 responsive-container" />,
                      color: 'purple',
                      delay: 1.5,
                    },
                  ].map((item, index) => (
                ...
                >
                  <div className="text-green-400 font-bold text-2xl responsive-container">
                    99.9%
                  </div>
