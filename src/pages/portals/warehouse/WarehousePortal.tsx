...
function WarehousePortal() {
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with warehouse #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
          ...
          subSubMenus: [
            {
              ...
              path: '/warehouses/list/active',
            },
            {
              id: 'inactive-warehouses',
              label: 'Inactive Warehouses',
              path: '/warehouses/list/inactive',
            },
            {
              id: 'pending-warehouses',
              label: 'Pending Warehouses',
              path: '/warehouses/list/pending',
            },
          ],
        },
        {
          ...
          icon: UserPlus,
          path: '/warehouses/actions',
          subSubMenus: [
            { id: 'add-warehouse', label: 'Add New Warehouse', path: '/warehouses/actions/add' },
            {
              id: 'import-warehouses',
              label: 'Import Warehouses',
              path: '/warehouses/actions/import',
            },
            {
              id: 'export-warehouses',
              label: 'Export Warehouses',
              path: '/warehouses/actions/export',
            },
          ],
        },
        {
          id: 'warehouse-verification',
          label: 'Verification',
          icon: UserCheck,
          path: '/warehouses/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/warehouses/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/warehouses/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/warehouses/verification/address',
            },
          ],
        },
      ],
      ...
      subMenus: [
        {
          ...
          icon: Users,
          path: '/analytics/warehouses',
          subSubMenus: [
            {
              id: 'warehouse-behavior',
              label: 'Warehouse Behavior',
              path: '/analytics/warehouses/behavior',
            },
            {
              id: 'warehouse-segments',
              label: 'Warehouse Segments',
              path: '/analytics/warehouses/segments',
            },
            {
              id: 'warehouse-lifetime',
              label: 'Warehouse Lifetime Value',
              path: '/analytics/warehouses/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review warehouse feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    {
      id: 3,
      title: 'Update warehouse records',
      priority: 'low',
      due: 'Next week',
      completed: true,
    },
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Warehouse Call', time: '2:00 PM', date: 'Today', type: 'call' },
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Warehouse Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search warehouses, orders, reports..."
                  value={searchQuery}
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Warehouse Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Warehouse Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Warehouse Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
