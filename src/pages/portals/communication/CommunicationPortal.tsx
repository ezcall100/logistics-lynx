...
function CommunicationPortal() {
  ...
  const notifications = [
    {
      id: 1,
      title: 'New communication registered',
  ...
  const recentActivity = [
    {
      id: 1,
      action: 'New communication created',
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with communication #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          subSubMenus: [
            {
              id: 'active-communications',
              label: 'Active Communications',
              path: '/communications/list/active',
            },
            {
              id: 'inactive-communications',
              label: 'Inactive Communications',
              path: '/communications/list/inactive',
            },
            {
              id: 'pending-communications',
              label: 'Pending Communications',
              path: '/communications/list/pending',
            },
          ],
        },
        {
          ...
          icon: UserPlus,
          path: '/communications/actions',
          subSubMenus: [
            {
              id: 'add-communication',
              label: 'Add New Communication',
              path: '/communications/actions/add',
            },
            {
              id: 'import-communications',
              label: 'Import Communications',
              path: '/communications/actions/import',
            },
            {
              id: 'export-communications',
              label: 'Export Communications',
              path: '/communications/actions/export',
            },
          ],
        },
        {
          id: 'communication-verification',
          label: 'Verification',
          icon: UserCheck,
          path: '/communications/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/communications/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/communications/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/communications/verification/address',
            },
          ],
        },
      ],
          ...
          subSubMenus: [
            {
              ...
              path: '/analytics/communications/behavior',
            },
            {
              id: 'communication-segments',
              label: 'Communication Segments',
              path: '/analytics/communications/segments',
            },
            {
              id: 'communication-lifetime',
              label: 'Communication Lifetime Value',
              path: '/analytics/communications/lifetime',
            },
          ],
        },
        {
  ...
  const emailList = [
    {
      id: 1,
      from: 'communication@example.com',
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review communication feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    {
      id: 3,
      title: 'Update communication records',
      priority: 'low',
      due: 'Next week',
      completed: true,
    },
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Communication Call', time: '2:00 PM', date: 'Today', type: 'call' },
  ...
  const notes = [
    {
      id: 1,
      title: 'Communication Meeting Notes',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search communications, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Communication Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="communication" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Communication Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Communication Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
