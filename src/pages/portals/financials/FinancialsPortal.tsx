...
function FinancialsPortal() {
  ...
  const notifications = [
    {
      id: 1,
      title: 'New financials registered',
    ...
    {
      id: 2,
      title: 'Financials status updated',
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with financials #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
  ...
  const menuItems = [
    ...
    },
    {
      ...
      subMenus: [
        {
          id: 'financials-list',
          label: 'Financials List',
          icon: Users,
          path: '/financialss/list',
          subSubMenus: [
            {
              id: 'active-financialss',
              label: 'Active Financialss',
              path: '/financialss/list/active',
            },
            {
              id: 'inactive-financialss',
              label: 'Inactive Financialss',
              path: '/financialss/list/inactive',
            },
            {
              id: 'pending-financialss',
              label: 'Pending Financialss',
              path: '/financialss/list/pending',
            },
          ],
        },
        {
          id: 'financials-actions',
          label: 'Financials Actions',
          icon: UserPlus,
          path: '/financialss/actions',
          subSubMenus: [
            { id: 'add-financials', label: 'Add New Financials', path: '/financialss/actions/add' },
            {
              id: 'import-financialss',
              label: 'Import Financialss',
              path: '/financialss/actions/import',
            },
            {
              id: 'export-financialss',
              label: 'Export Financialss',
              path: '/financialss/actions/export',
            },
          ],
        },
        {
          id: 'financials-verification',
          label: 'Verification',
          icon: UserCheck,
          path: '/financialss/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/financialss/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/financialss/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/financialss/verification/address',
            },
          ],
        },
      ],
    ...
    },
    {
      ...
      subMenus: [
        {
          id: 'financials-analytics',
          label: 'Financials Analytics',
          icon: Users,
          path: '/analytics/financialss',
          subSubMenus: [
            {
              id: 'financials-behavior',
              label: 'Financials Behavior',
              path: '/analytics/financialss/behavior',
            },
            {
              id: 'financials-segments',
              label: 'Financials Segments',
              path: '/analytics/financialss/segments',
            },
            {
              id: 'financials-lifetime',
              label: 'Financials Lifetime Value',
              path: '/analytics/financialss/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review financials feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    {
      id: 3,
      title: 'Update financials records',
      priority: 'low',
      due: 'Next week',
      completed: true,
    },
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Financials Call', time: '2:00 PM', date: 'Today', type: 'call' },
  ...
  const notes = [
    {
      id: 1,
      title: 'Financials Meeting Notes',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Financials Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search financialss, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Financials Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="financials" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Financials Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Financials Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
