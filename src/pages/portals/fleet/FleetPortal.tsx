...
function FleetPortal() {
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with fleet #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          path: '/fleets/list',
          subSubMenus: [
            { id: 'active-fleets', label: 'Active Fleets', path: '/fleets/list/active' },
            { id: 'inactive-fleets', label: 'Inactive Fleets', path: '/fleets/list/inactive' },
            { id: 'pending-fleets', label: 'Pending Fleets', path: '/fleets/list/pending' },
          ],
        },
        {
          id: 'fleet-actions',
          ...
          path: '/fleets/actions',
          subSubMenus: [
            { id: 'add-fleet', label: 'Add New Fleet', path: '/fleets/actions/add' },
            { id: 'import-fleets', label: 'Import Fleets', path: '/fleets/actions/import' },
            { id: 'export-fleets', label: 'Export Fleets', path: '/fleets/actions/export' },
          ],
        },
        {
          ...
          label: 'Verification',
          icon: UserCheck,
          path: '/fleets/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/fleets/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/fleets/verification/documents',
            },
            { id: 'verify-address', label: 'Verify Address', path: '/fleets/verification/address' },
          ],
        },
      ],
    },
      ...
      subMenus: [
        {
          ...
          subSubMenus: [
            { id: 'fleet-behavior', label: 'Fleet Behavior', path: '/analytics/fleets/behavior' },
            { id: 'fleet-segments', label: 'Fleet Segments', path: '/analytics/fleets/segments' },
            {
              id: 'fleet-lifetime',
              label: 'Fleet Lifetime Value',
              path: '/analytics/fleets/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review fleet feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    { id: 3, title: 'Update fleet records', priority: 'low', due: 'Next week', completed: true },
  ];
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Fleet Call', time: '2:00 PM', date: 'Today', type: 'call' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Fleet Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search fleets, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Fleet Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="fleet" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Fleet Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Fleet Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
