...
function OwnerOperatorPortal() {
  ...
  const performanceData = [
    {
      label: 'OwnerOperator Satisfaction',
      value: 92,
  ...
  const recentActivity = [
    {
      id: 1,
      action: 'New owneroperator created',
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with owneroperator #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
  ...
  const menuItems = [
    ...
    {
      id: 'owneroperator-management',
      label: 'OwnerOperator Management',
      icon: Users,
      color: 'text-emerald-600',
      path: '/owneroperators',
      subMenus: [
        {
          id: 'owneroperator-list',
          label: 'OwnerOperator List',
          icon: Users,
          path: '/owneroperators/list',
          subSubMenus: [
            {
              id: 'active-owneroperators',
              label: 'Active OwnerOperators',
              path: '/owneroperators/list/active',
            },
            {
              id: 'inactive-owneroperators',
              label: 'Inactive OwnerOperators',
              path: '/owneroperators/list/inactive',
            },
            {
              id: 'pending-owneroperators',
              label: 'Pending OwnerOperators',
              path: '/owneroperators/list/pending',
            },
          ],
        },
        {
          id: 'owneroperator-actions',
          label: 'OwnerOperator Actions',
          icon: UserPlus,
          path: '/owneroperators/actions',
          subSubMenus: [
            {
              id: 'add-owneroperator',
              label: 'Add New OwnerOperator',
              path: '/owneroperators/actions/add',
            },
            {
              id: 'import-owneroperators',
              label: 'Import OwnerOperators',
              path: '/owneroperators/actions/import',
            },
            {
              id: 'export-owneroperators',
              label: 'Export OwnerOperators',
              path: '/owneroperators/actions/export',
            },
          ],
        },
        {
          id: 'owneroperator-verification',
          label: 'Verification',
          icon: UserCheck,
          path: '/owneroperators/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/owneroperators/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/owneroperators/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/owneroperators/verification/address',
            },
          ],
        },
      ],
    ...
    },
    {
      ...
      subMenus: [
        {
          id: 'owneroperator-analytics',
          label: 'OwnerOperator Analytics',
          icon: Users,
          path: '/analytics/owneroperators',
          subSubMenus: [
            {
              id: 'owneroperator-behavior',
              label: 'OwnerOperator Behavior',
              path: '/analytics/owneroperators/behavior',
            },
            {
              id: 'owneroperator-segments',
              label: 'OwnerOperator Segments',
              path: '/analytics/owneroperators/segments',
            },
            {
              id: 'owneroperator-lifetime',
              label: 'OwnerOperator Lifetime Value',
              path: '/analytics/owneroperators/lifetime',
            },
          ],
        },
        {
  ...
  const emailList = [
    {
      id: 1,
      from: 'owneroperator@example.com',
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review owneroperator feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    {
      id: 3,
      title: 'Update owneroperator records',
      priority: 'low',
      due: 'Next week',
      completed: true,
    },
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'OwnerOperator Call', time: '2:00 PM', date: 'Today', type: 'call' },
  ...
  const notes = [
    {
      id: 1,
      title: 'OwnerOperator Meeting Notes',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search owneroperators, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Owner Operator Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="owneroperator" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Owner Operator
                  Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Owner Operator Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
