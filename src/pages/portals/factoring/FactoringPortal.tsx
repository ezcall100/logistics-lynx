...
function FactoringPortal() {
  ...
  const notifications = [
    {
      id: 1,
      title: 'New factoring registered',
    ...
    {
      id: 2,
      title: 'Factoring status updated',
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with factoring #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
  ...
  const menuItems = [
    ...
    },
    {
      ...
      subMenus: [
        {
          id: 'factoring-list',
          label: 'Factoring List',
          icon: Users,
          path: '/factorings/list',
          subSubMenus: [
            {
              id: 'active-factorings',
              label: 'Active Factorings',
              path: '/factorings/list/active',
            },
            {
              id: 'inactive-factorings',
              label: 'Inactive Factorings',
              path: '/factorings/list/inactive',
            },
            {
              id: 'pending-factorings',
              label: 'Pending Factorings',
              path: '/factorings/list/pending',
            },
          ],
        },
        {
          id: 'factoring-actions',
          label: 'Factoring Actions',
          icon: UserPlus,
          path: '/factorings/actions',
          subSubMenus: [
            { id: 'add-factoring', label: 'Add New Factoring', path: '/factorings/actions/add' },
            {
              id: 'import-factorings',
              label: 'Import Factorings',
              path: '/factorings/actions/import',
            },
            {
              id: 'export-factorings',
              label: 'Export Factorings',
              path: '/factorings/actions/export',
            },
          ],
        },
        {
          id: 'factoring-verification',
          label: 'Verification',
          icon: UserCheck,
          path: '/factorings/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/factorings/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/factorings/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/factorings/verification/address',
            },
          ],
        },
      ],
    ...
    },
    {
      ...
      subMenus: [
        {
          id: 'factoring-analytics',
          label: 'Factoring Analytics',
          icon: Users,
          path: '/analytics/factorings',
          subSubMenus: [
            {
              id: 'factoring-behavior',
              label: 'Factoring Behavior',
              path: '/analytics/factorings/behavior',
            },
            {
              id: 'factoring-segments',
              label: 'Factoring Segments',
              path: '/analytics/factorings/segments',
            },
            {
              id: 'factoring-lifetime',
              label: 'Factoring Lifetime Value',
              path: '/analytics/factorings/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review factoring feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    {
      id: 3,
      title: 'Update factoring records',
      priority: 'low',
      due: 'Next week',
      completed: true,
    },
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Factoring Call', time: '2:00 PM', date: 'Today', type: 'call' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Factoring Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search factorings, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Factoring Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="factoring" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Factoring Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Factoring Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
