...
console.log('🔧 FINAL IMPORT QUOTE FIX');
console.log('Fixing remaining unterminated string literals in import statements...\n');

const patterns = [
  // Fix unterminated string literals in import statements: Button, Input, Card  ' => Button, Input, Card
  {
    name: 'Fix unterminated string literals in import statements',
    regex: /([^}]+)\s*'\s*$/gm,
    replacement: '$1'
  },
...
try {
  ...
  console.log(`\n🔧 Final import quote fix complete! Fixed ${fixedCount} files.`);
  console.log('\n🧹 Next steps:');
