...
function DirectoryPortal() {
  ...
  const notifications = [
    {
      id: 1,
      title: 'New directory registered',
    ...
    {
      id: 2,
      title: 'Directory status updated',
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with directory #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          icon: Users,
          path: '/directorys/list',
          subSubMenus: [
            {
              id: 'active-directorys',
              label: 'Active Directorys',
              path: '/directorys/list/active',
            },
            {
              id: 'inactive-directorys',
              label: 'Inactive Directorys',
              path: '/directorys/list/inactive',
            },
            {
              id: 'pending-directorys',
              label: 'Pending Directorys',
              path: '/directorys/list/pending',
            },
          ],
        },
        {
          ...
          icon: UserPlus,
          path: '/directorys/actions',
          subSubMenus: [
            { id: 'add-directory', label: 'Add New Directory', path: '/directorys/actions/add' },
            {
              id: 'import-directorys',
              label: 'Import Directorys',
              path: '/directorys/actions/import',
            },
            {
              id: 'export-directorys',
              label: 'Export Directorys',
              path: '/directorys/actions/export',
            },
          ],
        },
        {
          id: 'directory-verification',
          label: 'Verification',
          icon: UserCheck,
          path: '/directorys/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/directorys/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/directorys/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/directorys/verification/address',
            },
          ],
        },
      ],
      ...
      subMenus: [
        {
          ...
          icon: Users,
          path: '/analytics/directorys',
          subSubMenus: [
            {
              id: 'directory-behavior',
              label: 'Directory Behavior',
              path: '/analytics/directorys/behavior',
            },
            {
              id: 'directory-segments',
              label: 'Directory Segments',
              path: '/analytics/directorys/segments',
            },
            {
              id: 'directory-lifetime',
              label: 'Directory Lifetime Value',
              path: '/analytics/directorys/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review directory feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    {
      id: 3,
      title: 'Update directory records',
      priority: 'low',
      due: 'Next week',
      completed: true,
    },
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Directory Call', time: '2:00 PM', date: 'Today', type: 'call' },
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Directory Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search directorys, orders, reports..."
                  value={searchQuery}
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Directory Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Directory Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Directory Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
