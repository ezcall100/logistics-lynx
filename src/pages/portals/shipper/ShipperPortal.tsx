...
function ShipperPortal() {
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with shipper #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          path: '/shippers/list',
          subSubMenus: [
            { id: 'active-shippers', label: 'Active Shippers', path: '/shippers/list/active' },
            {
              id: 'inactive-shippers',
              label: 'Inactive Shippers',
              path: '/shippers/list/inactive',
            },
            { id: 'pending-shippers', label: 'Pending Shippers', path: '/shippers/list/pending' },
          ],
        },
        {
          id: 'shipper-actions',
          ...
          icon: UserPlus,
          path: '/shippers/actions',
          subSubMenus: [
            { id: 'add-shipper', label: 'Add New Shipper', path: '/shippers/actions/add' },
            { id: 'import-shippers', label: 'Import Shippers', path: '/shippers/actions/import' },
            { id: 'export-shippers', label: 'Export Shippers', path: '/shippers/actions/export' },
          ],
        },
        {
          ...
          label: 'Verification',
          icon: UserCheck,
          path: '/shippers/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/shippers/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/shippers/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/shippers/verification/address',
            },
          ],
        },
      ],
      ...
      subMenus: [
        {
          ...
          label: 'Shipper Analytics',
          icon: Users,
          path: '/analytics/shippers',
          subSubMenus: [
            {
              id: 'shipper-behavior',
              label: 'Shipper Behavior',
              path: '/analytics/shippers/behavior',
            },
            {
              id: 'shipper-segments',
              label: 'Shipper Segments',
              path: '/analytics/shippers/segments',
            },
            {
              id: 'shipper-lifetime',
              label: 'Shipper Lifetime Value',
              path: '/analytics/shippers/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review shipper feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    { id: 3, title: 'Update shipper records', priority: 'low', due: 'Next week', completed: true },
  ];
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Shipper Call', time: '2:00 PM', date: 'Today', type: 'call' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Shipper Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search shippers, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Shipper Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="shipper" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Shipper Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Shipper Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
