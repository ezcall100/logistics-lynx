...
function DocumentPortal() {
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with document #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          path: '/documents/list',
          subSubMenus: [
            { id: 'active-documents', label: 'Active Documents', path: '/documents/list/active' },
            {
              id: 'inactive-documents',
              label: 'Inactive Documents',
              path: '/documents/list/inactive',
            },
            {
        ...
        },
        {
          ...
          subSubMenus: [
            { id: 'add-document', label: 'Add New Document', path: '/documents/actions/add' },
            {
              id: 'import-documents',
              label: 'Import Documents',
              path: '/documents/actions/import',
            },
            {
              id: 'export-documents',
              label: 'Export Documents',
              path: '/documents/actions/export',
            },
          ],
        },
        {
          ...
          subSubMenus: [
            {
              ...
              path: '/documents/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/documents/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/documents/verification/address',
            },
          ],
        },
      ],
          ...
          subSubMenus: [
            {
              ...
              path: '/analytics/documents/behavior',
            },
            {
              id: 'document-segments',
              label: 'Document Segments',
              path: '/analytics/documents/segments',
            },
            {
              id: 'document-lifetime',
              label: 'Document Lifetime Value',
              path: '/analytics/documents/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review document feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    { id: 3, title: 'Update document records', priority: 'low', due: 'Next week', completed: true },
  ];
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Document Call', time: '2:00 PM', date: 'Today', type: 'call' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Document Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search documents, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Document Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="document" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Document Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Document Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
