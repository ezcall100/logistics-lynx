...
function SecurityPortal() {
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with security #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          path: '/securitys/list',
          subSubMenus: [
            { id: 'active-securitys', label: 'Active Securitys', path: '/securitys/list/active' },
            {
              id: 'inactive-securitys',
              label: 'Inactive Securitys',
              path: '/securitys/list/inactive',
            },
            {
              id: 'pending-securitys',
              label: 'Pending Securitys',
              path: '/securitys/list/pending',
            },
          ],
        },
        {
          ...
          icon: UserPlus,
          path: '/securitys/actions',
          subSubMenus: [
            { id: 'add-security', label: 'Add New Security', path: '/securitys/actions/add' },
            {
              id: 'import-securitys',
              label: 'Import Securitys',
              path: '/securitys/actions/import',
            },
            {
              id: 'export-securitys',
              label: 'Export Securitys',
              path: '/securitys/actions/export',
            },
          ],
        },
        {
          ...
          label: 'Verification',
          icon: UserCheck,
          path: '/securitys/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/securitys/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/securitys/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/securitys/verification/address',
            },
          ],
        },
      ],
      ...
      subMenus: [
        {
          ...
          icon: Users,
          path: '/analytics/securitys',
          subSubMenus: [
            {
              id: 'security-behavior',
              label: 'Security Behavior',
              path: '/analytics/securitys/behavior',
            },
            {
              id: 'security-segments',
              label: 'Security Segments',
              path: '/analytics/securitys/segments',
            },
            {
              id: 'security-lifetime',
              label: 'Security Lifetime Value',
              path: '/analytics/securitys/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    { id: 3, title: 'Update security records', priority: 'low', due: 'Next week', completed: true },
  ];
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Security Call', time: '2:00 PM', date: 'Today', type: 'call' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Security Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search securitys, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Security Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="security" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Security Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Security Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
