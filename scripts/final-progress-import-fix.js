...
console.log('🔧 FINAL PROGRESS IMPORT FIX');
console.log('Fixing remaining unterminated string literals in progress component imports...\n');

const patterns = [
  // Fix unterminated string literals in progress component imports: } from '@/components/ui/progress => } from '@/components/ui/progress'
  {
    name: 'Fix unterminated string literals in progress component imports',
    regex: /}\s+from\s+'@\/components\/ui\/progress\s*$/gm,
    replacement: "} from '@/components/ui/progress'"
  },
...
try {
  ...
  console.log(`\n🔧 Final progress import fix complete! Fixed ${fixedCount} files.`);
  console.log('\n🧹 Next steps:');
