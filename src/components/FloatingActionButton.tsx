  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
            ...
            {fabActions.map((action, index) => (
              ...
              >
                ...
                <motion.div
                  ...
                  className="bg-transbot-text-primary text-white px-3 py-2 rounded-lg text-sm font-medium shadow-transbot whitespace-nowrap"
                >
                  {action.label}
                </motion.div>
      ...
      <motion.button
        ...
        className="w-14 h-14 bg-gradient-primary text-white rounded-full shadow-transbot-lg hover:shadow-transbot-xl transition-all duration-300 flex items-center justify-center relative overflow-hidden"
      >
      ...
      {!isExpanded && (
        <motion.div
          ...
          className="absolute -top-16 left-1/2 transform -translate-x-1/2 bg-white/90 backdrop-blur-sm rounded-lg px-3 py-2 shadow-transbot border border-transbot-border/20"
        >
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 bg-transbot-teal rounded-full animate-pulse"></div>
            <span className="text-xs font-semibold text-transbot-text-primary">
              AI Active
            </span>
          </div>
        </motion.div>
      ...
      >
        <div className="flex flex-col gap-2">
          {/* AI Status Indicator */}
          <motion.div
            className="p-2 bg-white/90 backdrop-blur-sm rounded-lg shadow-transbot border border-transbot-border/20"
            whileHover={{ scale: 1.05 }}
            transition={{ duration: 0.2 }}
          >
            <Brain className="w-4 h-4 text-transbot-sky" />
          </motion.div>
          ...
          <motion.div
            ...
            transition={{ duration: 0.2 }}
          >
            <BarChart3 className="w-4 h-4 text-transbot-teal" />
          </motion.div>
          ...
          <motion.div
            ...
            transition={{ duration: 0.2 }}
          >
            <HelpCircle className="w-4 h-4 text-transbot-warning" />
          </motion.div>
        </div>
      </motion.div>
    </div>
