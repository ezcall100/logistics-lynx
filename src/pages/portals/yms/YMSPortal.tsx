...
function YMSPortal() {
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with yms #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          path: '/ymss/list',
          subSubMenus: [
            { id: 'active-ymss', label: 'Active YMSs', path: '/ymss/list/active' },
            { id: 'inactive-ymss', label: 'Inactive YMSs', path: '/ymss/list/inactive' },
            { id: 'pending-ymss', label: 'Pending YMSs', path: '/ymss/list/pending' },
          ],
        },
        {
          id: 'yms-actions',
          ...
          path: '/ymss/actions',
          subSubMenus: [
            { id: 'add-yms', label: 'Add New YMS', path: '/ymss/actions/add' },
            { id: 'import-ymss', label: 'Import YMSs', path: '/ymss/actions/import' },
            { id: 'export-ymss', label: 'Export YMSs', path: '/ymss/actions/export' },
          ],
        },
        {
          id: 'yms-verification',
          label: 'Verification',
          icon: UserCheck,
          path: '/ymss/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/ymss/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/ymss/verification/documents',
            },
            { id: 'verify-address', label: 'Verify Address', path: '/ymss/verification/address' },
          ],
        },
      ],
    },
      ...
      subMenus: [
        {
          ...
          path: '/analytics/ymss',
          subSubMenus: [
            { id: 'yms-behavior', label: 'YMS Behavior', path: '/analytics/ymss/behavior' },
            { id: 'yms-segments', label: 'YMS Segments', path: '/analytics/ymss/segments' },
            { id: 'yms-lifetime', label: 'YMS Lifetime Value', path: '/analytics/ymss/lifetime' },
          ],
        },
        {
  ...
  const emailList = [
    { id: 1, from: 'yms@example.com', subject: 'Order Inquiry', time: '1 hour ago', unread: true },
    {
      id: 2,
  ...
  const tasks = [
    ...
    { id: 2, title: 'Review yms feedback', priority: 'medium', due: 'Tomorrow', completed: false },
    { id: 3, title: 'Update yms records', priority: 'low', due: 'Next week', completed: true },
  ];
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'YMS Call', time: '2:00 PM', date: 'Today', type: 'call' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">YMS Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search ymss, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">YMS Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="yms" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your YMS Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
            ...
            <div className="bg-white/70 backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-gray-200/50">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Key performance indicators for YMS Portal</p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
