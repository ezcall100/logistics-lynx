...
function BillingPortal() {
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with billing #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          path: '/billings/list',
          subSubMenus: [
            { id: 'active-billings', label: 'Active Billings', path: '/billings/list/active' },
            {
              id: 'inactive-billings',
              label: 'Inactive Billings',
              path: '/billings/list/inactive',
            },
            { id: 'pending-billings', label: 'Pending Billings', path: '/billings/list/pending' },
          ],
        },
        {
          id: 'billing-actions',
          ...
          icon: UserPlus,
          path: '/billings/actions',
          subSubMenus: [
            { id: 'add-billing', label: 'Add New Billing', path: '/billings/actions/add' },
            { id: 'import-billings', label: 'Import Billings', path: '/billings/actions/import' },
            { id: 'export-billings', label: 'Export Billings', path: '/billings/actions/export' },
          ],
        },
        {
          ...
          label: 'Verification',
          icon: UserCheck,
          path: '/billings/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/billings/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/billings/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/billings/verification/address',
            },
          ],
        },
      ],
      ...
      subMenus: [
        {
          ...
          icon: Users,
          path: '/analytics/billings',
          subSubMenus: [
            {
              id: 'billing-behavior',
              label: 'Billing Behavior',
              path: '/analytics/billings/behavior',
            },
            {
              id: 'billing-segments',
              label: 'Billing Segments',
              path: '/analytics/billings/segments',
            },
            {
              id: 'billing-lifetime',
              label: 'Billing Lifetime Value',
              path: '/analytics/billings/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review billing feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    { id: 3, title: 'Update billing records', priority: 'low', due: 'Next week', completed: true },
  ];
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Billing Call', time: '2:00 PM', date: 'Today', type: 'call' },
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Billing Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search billings, orders, reports..."
                  value={searchQuery}
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Billing Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Billing Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Billing Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
