...
import { Mail, Lock, Eye, EyeOff, ArrowRight, Truck, Shield, AlertCircle, User, LogOut, Package, Users, DollarSign, BarChart3, Calendar, Settings, Bot, Zap, Plus, Bell } from 'lucide-react';
                ...
                <div>
                  ...
                  <div className="flex">
                    <input
                      ...
                      required
                    />
                    <span className="px-3 py-3 bg-gray-100 border border-l-0 border-gray-300 rounded-r-lg text-gray-500 text-sm">
                      .transbotai.com
                    </span>
                  </div>
                  <p className="text-xs text-gray-500 mt-1">This will be your portal URL: {signupSubdomain || 'your-company'}.transbotai.com</p>
                </div>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm border-b border-gray-200 fixed top-0 left-0 right-0 z-50">
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            {/* Profile Dropdown */}
            <div className="relative">
              <button className="flex items-center space-x-3 text-gray-700 hover:text-gray-900 px-3 py-2 rounded-lg hover:bg-gray-100 transition-colors">
      ...
      <div className="flex pt-16">
        ...
        <aside className="w-64 bg-white shadow-sm min-h-screen fixed left-0 top-16 z-40">
          <nav className="p-4">
            <div className="space-y-2">
              <a href="#" className="flex items-center space-x-3 px-3 py-2 text-blue-600 bg-blue-50 rounded-lg transition-colors">
