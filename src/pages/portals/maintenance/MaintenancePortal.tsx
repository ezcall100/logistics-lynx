...
function MaintenancePortal() {
  ...
  const notifications = [
    {
      id: 1,
      title: 'New maintenance registered',
  ...
  const performanceData = [
    {
      label: 'Maintenance Satisfaction',
      value: 92,
  ...
  const recentActivity = [
    {
      id: 1,
      action: 'New maintenance created',
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with maintenance #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          subSubMenus: [
            {
              id: 'active-maintenances',
              label: 'Active Maintenances',
              path: '/maintenances/list/active',
            },
            {
              id: 'inactive-maintenances',
              label: 'Inactive Maintenances',
              path: '/maintenances/list/inactive',
            },
            {
              id: 'pending-maintenances',
              label: 'Pending Maintenances',
              path: '/maintenances/list/pending',
            },
          ],
        },
        {
          ...
          icon: UserPlus,
          path: '/maintenances/actions',
          subSubMenus: [
            {
              id: 'add-maintenance',
              label: 'Add New Maintenance',
              path: '/maintenances/actions/add',
            },
            {
              id: 'import-maintenances',
              label: 'Import Maintenances',
              path: '/maintenances/actions/import',
            },
            {
              id: 'export-maintenances',
              label: 'Export Maintenances',
              path: '/maintenances/actions/export',
            },
          ],
        },
        {
          id: 'maintenance-verification',
          label: 'Verification',
          icon: UserCheck,
          path: '/maintenances/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/maintenances/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/maintenances/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/maintenances/verification/address',
            },
          ],
        },
      ],
      ...
      subMenus: [
        {
          ...
          icon: Users,
          path: '/analytics/maintenances',
          subSubMenus: [
            {
              id: 'maintenance-behavior',
              label: 'Maintenance Behavior',
              path: '/analytics/maintenances/behavior',
            },
            {
              id: 'maintenance-segments',
              label: 'Maintenance Segments',
              path: '/analytics/maintenances/segments',
            },
            {
              id: 'maintenance-lifetime',
              label: 'Maintenance Lifetime Value',
              path: '/analytics/maintenances/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review maintenance feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Maintenance Call', time: '2:00 PM', date: 'Today', type: 'call' },
  ...
  const notes = [
    {
      id: 1,
      title: 'Maintenance Meeting Notes',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Maintenance Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search maintenances, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Maintenance Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="maintenance" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Maintenance Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Maintenance Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
