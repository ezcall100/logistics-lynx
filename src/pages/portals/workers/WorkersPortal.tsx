...
function WorkersPortal() {
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with workers #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          path: '/workerss/list',
          subSubMenus: [
            { id: 'active-workerss', label: 'Active Workerss', path: '/workerss/list/active' },
            {
              id: 'inactive-workerss',
              label: 'Inactive Workerss',
              path: '/workerss/list/inactive',
            },
            { id: 'pending-workerss', label: 'Pending Workerss', path: '/workerss/list/pending' },
          ],
        },
        {
          id: 'workers-actions',
          label: 'Workers Actions',
          icon: UserPlus,
          path: '/workerss/actions',
          subSubMenus: [
            { id: 'add-workers', label: 'Add New Workers', path: '/workerss/actions/add' },
            { id: 'import-workerss', label: 'Import Workerss', path: '/workerss/actions/import' },
            { id: 'export-workerss', label: 'Export Workerss', path: '/workerss/actions/export' },
          ],
        },
        {
          id: 'workers-verification',
          label: 'Verification',
          icon: UserCheck,
          path: '/workerss/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/workerss/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/workerss/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/workerss/verification/address',
            },
          ],
        },
      ],
      ...
      subMenus: [
        {
          ...
          icon: Users,
          path: '/analytics/workerss',
          subSubMenus: [
            {
              id: 'workers-behavior',
              label: 'Workers Behavior',
              path: '/analytics/workerss/behavior',
            },
            {
              id: 'workers-segments',
              label: 'Workers Segments',
              path: '/analytics/workerss/segments',
            },
            {
              id: 'workers-lifetime',
              label: 'Workers Lifetime Value',
              path: '/analytics/workerss/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review workers feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    { id: 3, title: 'Update workers records', priority: 'low', due: 'Next week', completed: true },
  ];
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Workers Call', time: '2:00 PM', date: 'Today', type: 'call' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Workers Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search workerss, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Workers Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="workers" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Workers Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Workers Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
