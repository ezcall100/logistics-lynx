...
function LoadboardPortal() {
  ...
  const notifications = [
    {
      id: 1,
      title: 'New loadboard registered',
    ...
    {
      id: 2,
      title: 'Loadboard status updated',
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with loadboard #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
  ...
  const menuItems = [
    ...
    {
      id: 'loadboard-management',
      label: 'Loadboard Management',
      icon: Users,
      color: 'text-emerald-600',
      path: '/loadboards',
      subMenus: [
        {
          id: 'loadboard-list',
          label: 'Loadboard List',
          icon: Users,
          path: '/loadboards/list',
          subSubMenus: [
            {
              id: 'active-loadboards',
              label: 'Active Loadboards',
              path: '/loadboards/list/active',
            },
            {
              id: 'inactive-loadboards',
              label: 'Inactive Loadboards',
              path: '/loadboards/list/inactive',
            },
            {
              id: 'pending-loadboards',
              label: 'Pending Loadboards',
              path: '/loadboards/list/pending',
            },
          ],
        },
        {
          id: 'loadboard-actions',
          label: 'Loadboard Actions',
          icon: UserPlus,
          path: '/loadboards/actions',
          subSubMenus: [
            { id: 'add-loadboard', label: 'Add New Loadboard', path: '/loadboards/actions/add' },
            {
              id: 'import-loadboards',
              label: 'Import Loadboards',
              path: '/loadboards/actions/import',
            },
            {
              id: 'export-loadboards',
              label: 'Export Loadboards',
              path: '/loadboards/actions/export',
            },
          ],
        },
        {
          id: 'loadboard-verification',
          label: 'Verification',
          icon: UserCheck,
          path: '/loadboards/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/loadboards/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/loadboards/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/loadboards/verification/address',
            },
          ],
        },
      ],
    ...
    },
    {
      ...
      subMenus: [
        {
          id: 'loadboard-analytics',
          label: 'Loadboard Analytics',
          icon: Users,
          path: '/analytics/loadboards',
          subSubMenus: [
            {
              id: 'loadboard-behavior',
              label: 'Loadboard Behavior',
              path: '/analytics/loadboards/behavior',
            },
            {
              id: 'loadboard-segments',
              label: 'Loadboard Segments',
              path: '/analytics/loadboards/segments',
            },
            {
              id: 'loadboard-lifetime',
              label: 'Loadboard Lifetime Value',
              path: '/analytics/loadboards/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review loadboard feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    {
      id: 3,
      title: 'Update loadboard records',
      priority: 'low',
      due: 'Next week',
      completed: true,
    },
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Loadboard Call', time: '2:00 PM', date: 'Today', type: 'call' },
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Loadboard Portal</p>
                </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Loadboard Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Loadboard Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Loadboard Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
