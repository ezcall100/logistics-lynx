...
function CompliancePortal() {
  ...
  const notifications = [
    {
      id: 1,
      title: 'New compliance registered',
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with compliance #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          icon: Users,
          path: '/compliances/list',
          subSubMenus: [
            {
              id: 'active-compliances',
              label: 'Active Compliances',
              path: '/compliances/list/active',
            },
            {
              id: 'inactive-compliances',
              label: 'Inactive Compliances',
              path: '/compliances/list/inactive',
            },
            {
              id: 'pending-compliances',
              label: 'Pending Compliances',
              path: '/compliances/list/pending',
            },
          ],
        },
        {
          ...
          icon: UserPlus,
          path: '/compliances/actions',
          subSubMenus: [
            { id: 'add-compliance', label: 'Add New Compliance', path: '/compliances/actions/add' },
            {
              id: 'import-compliances',
              label: 'Import Compliances',
              path: '/compliances/actions/import',
            },
            {
              id: 'export-compliances',
              label: 'Export Compliances',
              path: '/compliances/actions/export',
            },
          ],
        },
        {
          ...
          label: 'Verification',
          icon: UserCheck,
          path: '/compliances/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/compliances/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/compliances/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/compliances/verification/address',
            },
          ],
        },
      ],
      ...
      subMenus: [
        {
          ...
          icon: Users,
          path: '/analytics/compliances',
          subSubMenus: [
            {
              id: 'compliance-behavior',
              label: 'Compliance Behavior',
              path: '/analytics/compliances/behavior',
            },
            {
              id: 'compliance-segments',
              label: 'Compliance Segments',
              path: '/analytics/compliances/segments',
            },
            {
              id: 'compliance-lifetime',
              label: 'Compliance Lifetime Value',
              path: '/analytics/compliances/lifetime',
            },
          ],
        },
        {
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Compliance Call', time: '2:00 PM', date: 'Today', type: 'call' },
  ...
  const notes = [
    {
      id: 1,
      title: 'Compliance Meeting Notes',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Compliance Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search compliances, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Compliance Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="compliance" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Compliance Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Compliance Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
