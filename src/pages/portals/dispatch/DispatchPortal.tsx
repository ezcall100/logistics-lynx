...
function DispatchPortal() {
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with dispatch #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          path: '/dispatchs/list',
          subSubMenus: [
            { id: 'active-dispatchs', label: 'Active Dispatchs', path: '/dispatchs/list/active' },
            {
              id: 'inactive-dispatchs',
              label: 'Inactive Dispatchs',
              path: '/dispatchs/list/inactive',
            },
            {
              id: 'pending-dispatchs',
              label: 'Pending Dispatchs',
              path: '/dispatchs/list/pending',
            },
          ],
        },
        {
          ...
          icon: UserPlus,
          path: '/dispatchs/actions',
          subSubMenus: [
            { id: 'add-dispatch', label: 'Add New Dispatch', path: '/dispatchs/actions/add' },
            {
              id: 'import-dispatchs',
              label: 'Import Dispatchs',
              path: '/dispatchs/actions/import',
            },
            {
              id: 'export-dispatchs',
              label: 'Export Dispatchs',
              path: '/dispatchs/actions/export',
            },
          ],
        },
        {
          ...
          label: 'Verification',
          icon: UserCheck,
          path: '/dispatchs/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/dispatchs/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/dispatchs/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/dispatchs/verification/address',
            },
          ],
        },
      ],
      ...
      subMenus: [
        {
          ...
          icon: Users,
          path: '/analytics/dispatchs',
          subSubMenus: [
            {
              id: 'dispatch-behavior',
              label: 'Dispatch Behavior',
              path: '/analytics/dispatchs/behavior',
            },
            {
              id: 'dispatch-segments',
              label: 'Dispatch Segments',
              path: '/analytics/dispatchs/segments',
            },
            {
              id: 'dispatch-lifetime',
              label: 'Dispatch Lifetime Value',
              path: '/analytics/dispatchs/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review dispatch feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    { id: 3, title: 'Update dispatch records', priority: 'low', due: 'Next week', completed: true },
  ];
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Dispatch Call', time: '2:00 PM', date: 'Today', type: 'call' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Dispatch Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search dispatchs, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Dispatch Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="dispatch" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Dispatch Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Dispatch Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
