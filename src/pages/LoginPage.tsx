        ...
        <div className="hidden lg:flex lg:w-1/2 flex-col justify-center px-12 xl:px-16">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Experience AI-powered logistics management that transforms your supply chain operations. 
              Join thousands of companies already optimizing with Trans Bot AI.
            </p>
