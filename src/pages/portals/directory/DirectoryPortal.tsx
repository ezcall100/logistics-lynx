    ...
    <div className="min-h-screen bg-gradient-to-br from-transbot-sky/5 via-white to-transbot-teal/5">
      <section className="pt-32 pb-8 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div>
              <h1 className="text-4xl font-bold text-transbot-text-primary mb-2">Directory Portal</h1>
              <p className="text-transbot-text-secondary">Comprehensive directory of logistics companies and partners</p>
            </div>
