...
const BrokerSolutions: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-pink-900 to-red-900 responsive-container">
      ...
      <div className="relative overflow-hidden responsive-container">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 responsive-container">
          <div className="text-center responsive-container">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-purple-500 to-pink-600 rounded-2xl mb-8 responsive-container">
              <Briefcase className="w-10 h-10 text-white responsive-container" />
            </div>
            ...
            <p className="text-xl md:text-2xl text-purple-200 mb-8 max-w-4xl mx-auto responsive-container">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center responsive-container">
              <button className="bg-gradient-to-r from-purple-500 to-pink-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:from-purple-600 hover:to-pink-700 transition-all duration-300 transform hover:scale-105 responsive-container" aria-label="Button">
                Start Free Trial
              </button>
      ...
      <div className="py-16 bg-white/5 backdrop-blur-lg responsive-container">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 responsive-container">
          <div className="text-center mb-12 responsive-container">
            ...
            <p className="text-xl text-purple-200 max-w-3xl mx-auto responsive-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 responsive-container">
            {brokerTypes.map((type, index) => (
              <div key={index} className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300 text-center responsive-container">
                ...
                <p className="text-purple-200 text-sm leading-relaxed responsive-container">{type.description}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 responsive-container">
            {features.map((feature, index) => (
              <div key={index} className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 hover:bg-white/15 transition-all duration-300 responsive-container">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-600 rounded-xl mb-6 responsive-container">
                ...
                <p className="text-purple-200 leading-relaxed responsive-container">{feature.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 responsive-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center responsive-container">
            <div>
              ...
              <p className="text-xl text-purple-200 mb-8 leading-relaxed responsive-container">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 responsive-container">
                {benefits.map((benefit, index) => (
                  <div key={index} className="flex items-center space-x-3 responsive-container">
                    <div className="w-6 h-6 bg-gradient-to-r from-purple-400 to-pink-500 rounded-full flex items-center justify-center responsive-container">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 responsive-container">
              <div className="text-center responsive-container">
                <BarChart3 className="w-16 h-16 text-purple-400 mx-auto mb-6 responsive-container" />
                <h3 className="text-2xl font-bold text-white mb-4 responsive-container">Broker Performance</h3>
                <div className="space-y-4 responsive-container">
                  <div className="flex justify-between items-center responsive-container">
                    <span className="text-purple-200 responsive-container">Load Volume</span>
                    <span className="text-purple-400 font-bold text-xl responsive-container">50% Increase</span>
                  </div>
                  <div className="flex justify-between items-center responsive-container">
                    <span className="text-purple-200 responsive-container">Profit Margins</span>
                    <span className="text-purple-400 font-bold text-xl responsive-container">35% Improvement</span>
                  </div>
                  <div className="flex justify-between items-center responsive-container">
                    <span className="text-purple-200 responsive-container">Operational Costs</span>
                    <span className="text-purple-400 font-bold text-xl responsive-container">40% Reduction</span>
                  </div>
                  <div className="flex justify-between items-center responsive-container">
                    <span className="text-purple-200 responsive-container">Customer Satisfaction</span>
                    <span className="text-purple-400 font-bold text-xl responsive-container">60% Increase</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* CTA Section */}
      <div className="py-24 bg-gradient-to-r from-purple-600 to-pink-700 responsive-container">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 responsive-container">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center responsive-container">
            <button className="bg-white text-purple-600 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 responsive-container" aria-label="Button">
              Start Free Trial
            </button>
