...
const YardManagementSolution: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-blue-900 to-indigo-900">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-green-500 to-blue-600 rounded-2xl mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 hover:bg-white/15 transition-all duration-300">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-green-500 to-blue-600 rounded-xl mb-6">
              ...
              <div className="text-center">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-green-200">Yard Dwell Time</span>
                    <span className="text-green-400 font-bold text-xl">40% Reduction</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-green-200">Gate Throughput</span>
                    <span className="text-green-400 font-bold text-xl">60% Increase</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-green-200">Yard Capacity</span>
                    <span className="text-green-400 font-bold text-xl">25% Increase</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-green-200">Operational Costs</span>
                    <span className="text-green-400 font-bold text-xl">30% Reduction</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* CTA Section */}
      <div className="py-24 bg-gradient-to-r from-green-600 to-blue-700">
