...
function InsurancePortal() {
  ...
  const notifications = [
    {
      id: 1,
      title: 'New insurance registered',
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with insurance #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          subSubMenus: [
            {
              id: 'active-insurances',
              label: 'Active Insurances',
              path: '/insurances/list/active',
            },
            {
              id: 'inactive-insurances',
              label: 'Inactive Insurances',
              path: '/insurances/list/inactive',
            },
            {
              id: 'pending-insurances',
              label: 'Pending Insurances',
              path: '/insurances/list/pending',
            },
          ],
        },
        {
          id: 'insurance-actions',
          label: 'Insurance Actions',
          icon: UserPlus,
          path: '/insurances/actions',
          subSubMenus: [
            { id: 'add-insurance', label: 'Add New Insurance', path: '/insurances/actions/add' },
            {
              id: 'import-insurances',
              label: 'Import Insurances',
              path: '/insurances/actions/import',
            },
            {
              id: 'export-insurances',
              label: 'Export Insurances',
              path: '/insurances/actions/export',
            },
          ],
        },
        {
          ...
          label: 'Verification',
          icon: UserCheck,
          path: '/insurances/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/insurances/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/insurances/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/insurances/verification/address',
            },
          ],
        },
      ],
      ...
      subMenus: [
        {
          ...
          icon: Users,
          path: '/analytics/insurances',
          subSubMenus: [
            {
              id: 'insurance-behavior',
              label: 'Insurance Behavior',
              path: '/analytics/insurances/behavior',
            },
            {
              id: 'insurance-segments',
              label: 'Insurance Segments',
              path: '/analytics/insurances/segments',
            },
            {
              id: 'insurance-lifetime',
              label: 'Insurance Lifetime Value',
              path: '/analytics/insurances/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review insurance feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Insurance Call', time: '2:00 PM', date: 'Today', type: 'call' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Insurance Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search insurances, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Insurance Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="insurance" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Insurance Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Insurance Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
