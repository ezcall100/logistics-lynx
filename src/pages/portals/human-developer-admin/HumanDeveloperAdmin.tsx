...
function HumanDeveloperAdmin() {
  ...
  const notifications = [
    {
      id: 1,
      title: 'New human created',
      message: 'Human Developer Admin #1234 has been added',
      time: '5 minutes ago',
      type: 'info',
    },
    {
  ...
  const recentActivity = [
    {
      id: 1,
      action: 'New human created',
      details: 'Human Developer Admin #1234 has been added to your network',
      time: '5 minutes ago',
      type: 'info',
      icon: Plus,
    },
    {
      ...
      details: 'Mark Johnson is now active with human #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
  ...
  const navigationItems = [
    ...
    { id: 'management', label: 'Management', icon: UserCog, active: false },
  ...
  return (
    ...
    <ErrorBoundary fallback={<div>Something went wrong</div>}>
            ...
            {/* Real-time Status */}
            <RealTimePortalStatus portalId="human-developer-admin" />
          </div>
        </main>
      </div>
...
export default HumanDeveloperAdmin;
