...
const SuperAdminPortal: React.FC<SuperAdminPortalProps> = ({ user, onLogout }) => {
  ...
  const renderOverview = () => (
    <div className="space-y-8 responsive-container sm:flex-col md:flex-row lg:grid">
      ...
      <motion.div
        ...
        className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 overflow-hidden responsive-container sm:flex-col md:flex-row lg:grid"
      >
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6 responsive-container sm:flex-col md:flex-row lg:grid">
          <h3 className="text-xl font-bold text-white responsive-container sm:flex-col md:flex-row lg:grid">Recent Platform Activity</h3>
          <p className="text-blue-100 mt-1 responsive-container sm:flex-col md:flex-row lg:grid">Latest updates across all companies</p>
        </div>
  ...
  const renderCompanies = () => (
    <div className="space-y-6 responsive-container sm:flex-col md:flex-row lg:grid">
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6 responsive-container sm:flex-col md:flex-row lg:grid">
        <div className="flex items-center space-x-4 responsive-container sm:flex-col md:flex-row lg:grid">
          <div className="flex-1 relative responsive-container sm:flex-col md:flex-row lg:grid">
            <input
              ...
              className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white/50 backdrop-blur-sm responsive-container sm:flex-col md:flex-row lg:grid"
            />
      ...
      {viewMode === 'grid' ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 responsive-container sm:flex-col md:flex-row lg:grid">
          {filteredCompanies.map((company, index) => (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: index * 0.1 }}
              className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 overflow-hidden hover:shadow-xl transition-all duration-300 hover:scale-105 responsive-container sm:flex-col md:flex-row lg:grid"
            >
              <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6 responsive-container sm:flex-col md:flex-row lg:grid">
                <div className="flex items-center justify-between responsive-container sm:flex-col md:flex-row lg:grid">
                  <div className="flex items-center space-x-3 responsive-container sm:flex-col md:flex-row lg:grid">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 overflow-hidden responsive-container sm:flex-col md:flex-row lg:grid">
          <div className="p-6 responsive-container sm:flex-col md:flex-row lg:grid">
            <p className="text-gray-600 responsive-container sm:flex-col md:flex-row lg:grid">List view implementation coming soon...</p>
          </div>
        </div>
      )}
    </div>
          ...
          <div className="flex-1 max-w-2xl mx-8 hidden md:block responsive-container sm:flex-col md:flex-row lg:grid">
            <div className="relative responsive-container sm:flex-col md:flex-row lg:grid">
              <input
                ...
                className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white/50 backdrop-blur-sm shadow-lg responsive-container sm:flex-col md:flex-row lg:grid"
              />
              <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400 responsive-container sm:flex-col md:flex-row lg:grid" />
