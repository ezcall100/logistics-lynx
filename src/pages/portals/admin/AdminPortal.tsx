...
function AdminPortal() {
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with admin #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          path: '/admins/list',
          subSubMenus: [
            { id: 'active-admins', label: 'Active Admins', path: '/admins/list/active' },
            { id: 'inactive-admins', label: 'Inactive Admins', path: '/admins/list/inactive' },
            { id: 'pending-admins', label: 'Pending Admins', path: '/admins/list/pending' },
          ],
        },
        {
          id: 'admin-actions',
          ...
          path: '/admins/actions',
          subSubMenus: [
            { id: 'add-admin', label: 'Add New Admin', path: '/admins/actions/add' },
            { id: 'import-admins', label: 'Import Admins', path: '/admins/actions/import' },
            { id: 'export-admins', label: 'Export Admins', path: '/admins/actions/export' },
          ],
        },
        {
          ...
          subSubMenus: [
            {
              ...
              path: '/admins/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/admins/verification/documents',
            },
            { id: 'verify-address', label: 'Verify Address', path: '/admins/verification/address' },
          ],
        },
      ],
    },
      ...
      subMenus: [
        {
          ...
          icon: Users,
          path: '/analytics/admins',
          subSubMenus: [
            { id: 'admin-behavior', label: 'Admin Behavior', path: '/analytics/admins/behavior' },
            { id: 'admin-segments', label: 'Admin Segments', path: '/analytics/admins/segments' },
            {
              id: 'admin-lifetime',
              label: 'Admin Lifetime Value',
              path: '/analytics/admins/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    { id: 3, title: 'Update admin records', priority: 'low', due: 'Next week', completed: true },
  ];
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Admin Call', time: '2:00 PM', date: 'Today', type: 'call' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search admins, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="admin" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Admin Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
                    Key performance indicators for Admin Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
