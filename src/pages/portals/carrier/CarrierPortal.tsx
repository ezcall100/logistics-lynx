...
function CarrierPortal() {
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with carrier #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
  ...
  const menuItems = [
      ...
      subMenus: [
        {
          ...
          path: '/carriers/list',
          subSubMenus: [
            { id: 'active-carriers', label: 'Active Carriers', path: '/carriers/list/active' },
            {
              id: 'inactive-carriers',
              label: 'Inactive Carriers',
              path: '/carriers/list/inactive',
            },
            { id: 'pending-carriers', label: 'Pending Carriers', path: '/carriers/list/pending' },
          ],
        },
        {
          id: 'carrier-actions',
          label: 'Carrier Actions',
          icon: UserPlus,
          path: '/carriers/actions',
          subSubMenus: [
            { id: 'add-carrier', label: 'Add New Carrier', path: '/carriers/actions/add' },
            { id: 'import-carriers', label: 'Import Carriers', path: '/carriers/actions/import' },
            { id: 'export-carriers', label: 'Export Carriers', path: '/carriers/actions/export' },
          ],
        },
        {
          ...
          subSubMenus: [
            {
              ...
              path: '/carriers/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/carriers/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/carriers/verification/address',
            },
          ],
        },
      ],
    ...
    },
    {
      ...
      subMenus: [
        {
          id: 'carrier-analytics',
          label: 'Carrier Analytics',
          icon: Users,
          path: '/analytics/carriers',
          subSubMenus: [
            {
              id: 'carrier-behavior',
              label: 'Carrier Behavior',
              path: '/analytics/carriers/behavior',
            },
            {
              id: 'carrier-segments',
              label: 'Carrier Segments',
              path: '/analytics/carriers/segments',
            },
            {
              id: 'carrier-lifetime',
              label: 'Carrier Lifetime Value',
              path: '/analytics/carriers/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review carrier feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    { id: 3, title: 'Update carrier records', priority: 'low', due: 'Next week', completed: true },
  ];
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Carrier Call', time: '2:00 PM', date: 'Today', type: 'call' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Carrier Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search carriers, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Carrier Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="carrier" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Carrier Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Carrier Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
