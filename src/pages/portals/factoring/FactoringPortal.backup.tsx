...
const FactoringPortal: React.FC = () => {
  ...
  const [invoices] = useState([
    {
      ...
      status: 'Approved',
      advanceRate: 85,
      advanceAmount: 13387.5,
      reserveAmount: 2362.5,
      daysOutstanding: 0,
    },
    {
      id: 'INV002',
      ...
      status: 'Pending',
      advanceRate: 85,
      advanceAmount: 10455.0,
      reserveAmount: 1845.0,
      daysOutstanding: 1,
    },
    {
      id: 'INV003',
      ...
      status: 'Paid',
      advanceRate: 85,
      advanceAmount: 7607.5,
      reserveAmount: 1342.5,
      daysOutstanding: 3,
    },
  ]);
  ...
  const stats = {
    ...
    totalAdvances: 412887.5,
    totalReserves: 72862.5,
    avgAdvanceRate: 85,
    daysToPay: 2.3,
  };
