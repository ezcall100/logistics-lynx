...
const SimpleSuperAdmin: React.FC<SimpleSuperAdminProps> = ({ user, onLogout }) => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-100 responsive-container sm:flex-col md:flex-row lg:grid">
      {/* Header */}
        ...
        <div className="flex items-center justify-between px-6 py-4 responsive-container sm:flex-col md:flex-row lg:grid">
          <div className="flex items-center space-x-4 responsive-container sm:flex-col md:flex-row lg:grid">
            ...
            <div className="flex items-center space-x-3 responsive-container sm:flex-col md:flex-row lg:grid">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900 responsive-container sm:flex-col md:flex-row lg:grid">Trans Bot AI</h1>
                <p className="text-sm text-gray-500 responsive-container sm:flex-col md:flex-row lg:grid">Super Admin Portal</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4 responsive-container sm:flex-col md:flex-row lg:grid">
            ...
            <div className="flex items-center space-x-2 responsive-container sm:flex-col md:flex-row lg:grid">
              ...
              <button
                onClick={onLogout}
                className="ml-4 bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors responsive-container sm:flex-col md:flex-row lg:grid"
               aria-label="Button">
      ...
      <div className="flex pt-16 responsive-container sm:flex-col md:flex-row lg:grid">
        ...
        <aside className={`${sidebarOpen ? 'w-64' : 'w-0'} bg-white shadow-lg min-h-screen fixed left-0 top-16 z-40 overflow-hidden transition-all duration-300 border-r border-gray-200`}>
          <div className="p-6 responsive-container sm:flex-col md:flex-row lg:grid">
            <nav className="space-y-2 responsive-container sm:flex-col md:flex-row lg:grid">
              <a href="#" className="flex items-center space-x-3 px-3 py-2 text-blue-600 bg-blue-50 rounded-lg responsive-container sm:flex-col md:flex-row lg:grid">
                <Bot className="w-5 h-5 responsive-container sm:flex-col md:flex-row lg:grid" />
                <span>Dashboard</span>
              </a>
              <a href="#" className="flex items-center space-x-3 px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-lg responsive-container sm:flex-col md:flex-row lg:grid">
        ...
        <main className={`flex-1 transition-all duration-300 ${sidebarOpen ? 'ml-64' : 'ml-0'}`}>
          <div className="p-8 responsive-container sm:flex-col md:flex-row lg:grid">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 responsive-container sm:flex-col md:flex-row lg:grid">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 responsive-container sm:flex-col md:flex-row lg:grid">Welcome to Trans Bot AI Super Admin Portal</h2>
              <p className="text-gray-600 mb-6 responsive-container sm:flex-col md:flex-row lg:grid">You are logged in as: <strong>{user.name}</strong></p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 responsive-container sm:flex-col md:flex-row lg:grid">
                <div className="bg-blue-50 p-6 rounded-lg responsive-container sm:flex-col md:flex-row lg:grid">
                  <h3 className="text-lg font-semibold text-blue-900 mb-2 responsive-container sm:flex-col md:flex-row lg:grid">Total Companies</h3>
                  <p className="text-3xl font-bold text-blue-600 responsive-container sm:flex-col md:flex-row lg:grid">4</p>
                </div>
                <div className="bg-green-50 p-6 rounded-lg responsive-container sm:flex-col md:flex-row lg:grid">
                  <h3 className="text-lg font-semibold text-green-900 mb-2 responsive-container sm:flex-col md:flex-row lg:grid">Total Users</h3>
                  <p className="text-3xl font-bold text-green-600 responsive-container sm:flex-col md:flex-row lg:grid">143</p>
                </div>
                <div className="bg-purple-50 p-6 rounded-lg responsive-container sm:flex-col md:flex-row lg:grid">
                  <h3 className="text-lg font-semibold text-purple-900 mb-2 responsive-container sm:flex-col md:flex-row lg:grid">Monthly Revenue</h3>
                  <p className="text-3xl font-bold text-purple-600 responsive-container sm:flex-col md:flex-row lg:grid">$39,900</p>
                </div>
              </div>
            </div>
          </div>
