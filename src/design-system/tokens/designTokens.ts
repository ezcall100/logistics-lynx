/**
 * MCP Agents - Advanced Design System Tokens
 * Enterprise-grade design tokens with glassmorphism and modern aesthetics
 */

export const designTokens = {
  // Color Palette - Sophisticated Enterprise Colors
  colors: {
  ...
  shadows: {
    ...
    colored: {
      ...
      secondary: '0 10px 25px -5px rgba(217, 70, 239, 0.3)',
  ...
  gradients: {
    ...
    glass: {
      ...
      medium: 'linear-gradient(135deg, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0.1) 100%)',
    ...
    background: {
      ...
      accent: 'linear-gradient(135deg, #0ea5e9 0%, #3b82f6 50%, #8b5cf6 100%)',
    },
  },
