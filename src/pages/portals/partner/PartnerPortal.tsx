...
function PartnerPortal() {
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with partner #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          path: '/partners/list',
          subSubMenus: [
            { id: 'active-partners', label: 'Active Partners', path: '/partners/list/active' },
            {
              id: 'inactive-partners',
              label: 'Inactive Partners',
              path: '/partners/list/inactive',
            },
            { id: 'pending-partners', label: 'Pending Partners', path: '/partners/list/pending' },
          ],
        },
        {
          id: 'partner-actions',
          ...
          subSubMenus: [
            { id: 'add-partner', label: 'Add New Partner', path: '/partners/actions/add' },
            { id: 'import-partners', label: 'Import Partners', path: '/partners/actions/import' },
            { id: 'export-partners', label: 'Export Partners', path: '/partners/actions/export' },
          ],
        },
        {
          ...
          subSubMenus: [
            {
              ...
              path: '/partners/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/partners/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/partners/verification/address',
            },
          ],
        },
      ],
      ...
      subMenus: [
        {
          ...
          subSubMenus: [
            {
              id: 'partner-behavior',
              label: 'Partner Behavior',
              path: '/analytics/partners/behavior',
            },
            {
              id: 'partner-segments',
              label: 'Partner Segments',
              path: '/analytics/partners/segments',
            },
            {
              id: 'partner-lifetime',
              label: 'Partner Lifetime Value',
              path: '/analytics/partners/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review partner feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    { id: 3, title: 'Update partner records', priority: 'low', due: 'Next week', completed: true },
  ];
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Partner Call', time: '2:00 PM', date: 'Today', type: 'call' },
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Partner Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search partners, orders, reports..."
                  value={searchQuery}
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Partner Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Partner Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
