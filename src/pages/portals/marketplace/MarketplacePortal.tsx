...
function MarketplacePortal() {
  ...
  const notifications = [
    {
      id: 1,
      title: 'New marketplace registered',
  ...
  const recentActivity = [
    {
      id: 1,
      action: 'New marketplace created',
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with marketplace #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          subSubMenus: [
            {
              id: 'active-marketplaces',
              label: 'Active Marketplaces',
              path: '/marketplaces/list/active',
            },
            {
              id: 'inactive-marketplaces',
              label: 'Inactive Marketplaces',
              path: '/marketplaces/list/inactive',
            },
            {
              id: 'pending-marketplaces',
              label: 'Pending Marketplaces',
              path: '/marketplaces/list/pending',
            },
          ],
        },
        {
          ...
          icon: UserPlus,
          path: '/marketplaces/actions',
          subSubMenus: [
            {
              id: 'add-marketplace',
              label: 'Add New Marketplace',
              path: '/marketplaces/actions/add',
            },
            {
              id: 'import-marketplaces',
              label: 'Import Marketplaces',
              path: '/marketplaces/actions/import',
            },
            {
              id: 'export-marketplaces',
              label: 'Export Marketplaces',
              path: '/marketplaces/actions/export',
            },
          ],
        },
        {
          ...
          label: 'Verification',
          icon: UserCheck,
          path: '/marketplaces/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/marketplaces/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/marketplaces/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/marketplaces/verification/address',
            },
          ],
        },
      ],
          ...
          subSubMenus: [
            {
              ...
              label: 'Marketplace Behavior',
              path: '/analytics/marketplaces/behavior',
            },
            {
              id: 'marketplace-segments',
              label: 'Marketplace Segments',
              path: '/analytics/marketplaces/segments',
            },
            {
              id: 'marketplace-lifetime',
              label: 'Marketplace Lifetime Value',
              path: '/analytics/marketplaces/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review marketplace feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    {
      id: 3,
      title: 'Update marketplace records',
      priority: 'low',
      due: 'Next week',
      completed: true,
    },
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Marketplace Call', time: '2:00 PM', date: 'Today', type: 'call' },
  ...
  const notes = [
    {
      id: 1,
      title: 'Marketplace Meeting Notes',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Marketplace Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search marketplaces, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Marketplace Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="marketplace" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Marketplace Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Marketplace Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
