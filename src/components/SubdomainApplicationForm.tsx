...
export function SubdomainApplicationForm() {
  ...
  if (isSubmitted) {
    return (
      <motion.div
        ...
        className="max-w-2xl mx-auto p-8 bg-white/90 backdrop-blur-md rounded-2xl shadow-lg border border-slate-200/50"
      >
        <div className="text-center">
          ...
          <p className="text-transbot-text-secondary mb-6">
          ...
          <div className="bg-slate-50 rounded-xl p-6 mb-6">
            <h3 className="font-semibold text-transbot-text-primary mb-3">What happens next?</h3>
            <div className="space-y-2 text-sm text-transbot-text-secondary">
          ...
          <button
            ...
            className="bg-gradient-primary text-white px-6 py-3 rounded-xl font-semibold hover:shadow-transbot-lg transition-all duration-300"
          >
  ...
  return (
    <motion.div
      ...
      className="max-w-4xl mx-auto p-8 bg-white/90 backdrop-blur-md rounded-2xl shadow-lg border border-slate-200/50"
    >
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-transbot-text-primary mb-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-white/80 border border-slate-200/50 rounded-xl text-transbot-text-primary placeholder-transbot-text-secondary focus:outline-none focus:ring-2 focus:ring-transbot-sky focus:border-transparent"
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
              {subdomainSuggestions.slice(0, 6).map((suggestion, index) => (
                <div
                  key={index}
                  className="p-3 bg-slate-50 rounded-lg text-sm text-transbot-text-secondary"
                >
        ...
        <div>
          ...
          />
          <p className="text-xs text-transbot-text-secondary mt-1">
        ...
        {/* Portal Selection */}
        <div>
          <label className="block text-sm font-medium text-transbot-text-primary mb-4">
              ...
              >
                <div className="flex items-start space-x-3">
                  <input
                    ...
                    className="mt-1 w-4 h-4 text-transbot-sky border-slate-300 rounded focus:ring-transbot-sky"
                  />
                  <div>
                    <h4 className="font-medium text-transbot-text-primary">{portal.name}</h4>
                    <p className="text-sm text-transbot-text-secondary">{portal.description}</p>
                  </div>
                </div>
              </motion.div>
            ))}
        ...
        <div className="text-center">
          <motion.button
            ...
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            className="bg-gradient-primary text-white px-8 py-4 rounded-xl font-semibold shadow-transbot hover:shadow-transbot-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2 mx-auto"
          >
            {isSubmitting ? (
          ...
          <p className="text-sm text-transbot-text-secondary mt-4">
