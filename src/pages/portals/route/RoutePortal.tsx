...
function RoutePortal() {
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with route #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          path: '/routes/list',
          subSubMenus: [
            { id: 'active-routes', label: 'Active Routes', path: '/routes/list/active' },
            { id: 'inactive-routes', label: 'Inactive Routes', path: '/routes/list/inactive' },
            { id: 'pending-routes', label: 'Pending Routes', path: '/routes/list/pending' },
          ],
        },
        {
          id: 'route-actions',
          ...
          path: '/routes/actions',
          subSubMenus: [
            { id: 'add-route', label: 'Add New Route', path: '/routes/actions/add' },
            { id: 'import-routes', label: 'Import Routes', path: '/routes/actions/import' },
            { id: 'export-routes', label: 'Export Routes', path: '/routes/actions/export' },
          ],
        },
        {
          ...
          subSubMenus: [
            {
              ...
              path: '/routes/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/routes/verification/documents',
            },
            { id: 'verify-address', label: 'Verify Address', path: '/routes/verification/address' },
          ],
        },
      ],
    },
      ...
      subMenus: [
        {
          ...
          subSubMenus: [
            { id: 'route-behavior', label: 'Route Behavior', path: '/analytics/routes/behavior' },
            { id: 'route-segments', label: 'Route Segments', path: '/analytics/routes/segments' },
            {
              id: 'route-lifetime',
              label: 'Route Lifetime Value',
              path: '/analytics/routes/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review route feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    { id: 3, title: 'Update route records', priority: 'low', due: 'Next week', completed: true },
  ];
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Route Call', time: '2:00 PM', date: 'Today', type: 'call' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Route Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search routes, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Route Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="route" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Route Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Route Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
