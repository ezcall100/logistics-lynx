...
const CarbonOptimizer = React.memo(function CarbonOptimizer() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-emerald-900 to-teal-900 responsive-container">
      ...
      <div className="relative overflow-hidden responsive-container">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 responsive-container">
          <div className="text-center responsive-container">
            ...
            >
              <Leaf className="w-10 h-10 text-white responsive-container" />
            </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 responsive-container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 responsive-container">
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 responsive-container">
            <h3 className="text-2xl font-bold text-white mb-6 responsive-container">Carbon Optimization</h3>
            
            <div className="space-y-4 mb-8 responsive-container">
              <div className="flex items-center justify-between responsive-container">
                <span className="text-green-200 responsive-container">Green Routes</span>
                <span className="text-white font-semibold responsive-container">92%</span>
              </div>
              <div className="flex items-center justify-between responsive-container">
                <span className="text-green-200 responsive-container">Electric Vehicles</span>
                <span className="text-white font-semibold responsive-container">85%</span>
              </div>
              <div className="flex items-center justify-between responsive-container">
                <span className="text-green-200 responsive-container">Renewable Energy</span>
                <span className="text-white font-semibold responsive-container">78%</span>
              </div>
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 responsive-container">
            <h3 className="text-2xl font-bold text-white mb-6 responsive-container">Environmental Impact</h3>
            ...
            <div className="space-y-6 responsive-container">
              <div className="flex items-center space-x-4 responsive-container">
                ...
                <div>
                  <div className="text-white font-semibold responsive-container">Carbon Reduction</div>
                  <div className="text-green-200 responsive-container">34.7% decrease</div>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 responsive-container">
                ...
                <div>
                  <div className="text-white font-semibold responsive-container">Green Routes</div>
                  <div className="text-green-200 responsive-container">18 optimized paths</div>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 responsive-container">
                ...
                <div>
                  <div className="text-white font-semibold responsive-container">Electric Fleet</div>
                  <div className="text-green-200 responsive-container">12 vehicles converted</div>
                </div>
              </div>
            </div>
          </div>
        ...
        >
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 responsive-container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 responsive-container">
              <div className="text-center responsive-container">
                <div className="text-3xl font-bold text-green-400 mb-2 responsive-container">{optimizationResults.carbonReduction}%</div>
                <div className="text-green-200 responsive-container">Carbon Reduction</div>
              </div>
              <div className="text-center responsive-container">
                <div className="text-3xl font-bold text-blue-400 mb-2 responsive-container">{optimizationResults.greenRoutes}</div>
                <div className="text-green-200 responsive-container">Green Routes</div>
              </div>
              <div className="text-center responsive-container">
                <div className="text-3xl font-bold text-purple-400 mb-2 responsive-container">{optimizationResults.electricVehicles}</div>
                <div className="text-green-200 responsive-container">Electric Vehicles</div>
              </div>
              <div className="text-center responsive-container">
                <div className="text-3xl font-bold text-yellow-400 mb-2 responsive-container">${optimizationResults.totalSavings}</div>
                <div className="text-green-200 responsive-container">Cost Savings</div>
              </div>
            </div>
          </div>
        </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 responsive-container">
        <h2 className="text-3xl font-bold text-white text-center mb-12 responsive-container">Carbon Optimization Features</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 responsive-container">
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 responsive-container">
            <div className="w-12 h-12 bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl flex items-center justify-center mb-4 responsive-container">
              <Leaf className="w-6 h-6 text-white responsive-container" />
            </div>
            <h3 className="text-xl font-bold text-white mb-3 responsive-container">Sustainable Routes</h3>
            <p className="text-green-200 responsive-container">AI-powered route optimization to minimize carbon footprint and environmental impact.</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 responsive-container">
            ...
            <h3 className="text-xl font-bold text-white mb-3 responsive-container">Environmental Tracking</h3>
            <p className="text-green-200 responsive-container">Real-time monitoring of carbon emissions and environmental impact metrics.</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 responsive-container">
            ...
            <h3 className="text-xl font-bold text-white mb-3 responsive-container">Green Fleet Management</h3>
            <p className="text-green-200 responsive-container">Optimize electric vehicle deployment and renewable energy integration.</p>
          </div>
        </div>
      </div>
    </div>
