  ...
  return (
    <div className={`responsive-sidebar-container ${className}`}>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-40 p-2 bg-white/70 dark:bg-slate-800/70 backdrop-blur-lg rounded-lg shadow-lg border border-gray-200 dark:border-slate-700"
      >
