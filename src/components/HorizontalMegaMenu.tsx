      ...
      items: [
        {
          ...
          icon: Globe,
          description: 'Complete TMS solution',
        },
        {
          id: 'route-optimizer',
        ...
        },
        {
          id: 'load-matching',
          label: 'Load Matching',
          href: '/solutions/load-matching',
          icon: Zap,
          description: 'Smart load-carrier matching',
        },
        {
          ...
          icon: BarChart3,
          description: 'Forecast and optimize',
        },
        {
          id: 'fleet-management',
          ...
          icon: Rocket,
          description: 'Comprehensive fleet control',
        },
        {
          ...
          icon: Package,
          description: 'Smart warehouse operations',
        },
        {
          ...
          icon: Truck,
          description: 'Optimized final delivery',
        },
        {
          id: 'yard-management',
          ...
          icon: MapPin,
          description: 'Optimize yard operations',
        },
        {
        ...
        {
          id: 'shipper-solutions',
          label: 'Shipper Solutions',
          href: '/solutions/shipper',
          icon: Package,
          description: 'Solutions for shippers',
        },
        {
          id: 'carrier-solutions',
          label: 'Carrier Solutions',
          href: '/solutions/carrier',
          icon: Truck,
          description: 'Solutions for carriers',
        },
        {
          id: 'broker-solutions',
          label: 'Broker Solutions',
          href: '/solutions/broker',
          icon: Briefcase,
          description: 'Solutions for brokers',
        },
        {
          id: 'owner-operator-solutions',
          label: 'Owner Operator Solutions',
          href: '/solutions/owner-operator',
          icon: Truck,
          description: 'Solutions for owner operators',
        },
        {
          id: 'driver-solutions',
          label: 'Driver Solutions',
          href: '/solutions/driver',
          icon: User,
          description: 'Solutions for drivers',
        },
      ],
      featured: [
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: BarChart3,
          description: 'Predict trends and optimize',
        },
        {
          id: 'fleet-manager',
          label: 'Fleet Manager',
          href: '/agents/fleet-manager',
          icon: Rocket,
          description: 'Manage fleet operations',
        },
        {
          id: 'fuel-optimizer',
          label: 'Fuel Optimizer',
          href: '/agents/fuel-optimizer',
          icon: Zap,
        ...
        },
        {
          ...
          href: '/agents/demand-forecaster',
          icon: BarChart3,
          description: 'Predict shipping demand',
        },
        {
          id: 'price-optimizer',
          label: 'Price Optimizer',
          href: '/agents/price-optimizer',
          icon: TrendingUp,
        ...
        },
        {
          ...
          href: '/agents/maintenance-predictor',
          icon: Target,
          description: 'Predictive maintenance alerts',
        },
        {
          id: 'carbon-optimizer',
          label: 'Carbon Optimizer',
        ...
        },
        {
          ...
          href: '/agents/smart-warehouse',
          icon: Package,
          description: 'Autonomous warehouse operations',
        },
        {
          id: 'customer-experience',
          label: 'Customer Experience',
          href: '/agents/customer-experience',
          icon: Heart,
      ...
      items: [
        {
          ...
          href: '/technology',
          icon: Code,
          description: 'Complete technology stack overview',
        },
        {
          id: 'ai-technology',
          label: 'AI Technology',
        ...
        },
        {
          ...
          icon: Shield,
          description: 'Secure blockchain technology',
        },
        {
      ...
      items: [
        {
          ...
          href: '/company',
          icon: Users,
          description: 'Learn about Trans Bot AI',
        },
        {
          id: 'careers',
          label: 'Careers',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: Users,
          description: 'Live events and recordings',
        },
        {
          id: 'help-center',
          label: 'Help Center',
            ...
            <div className="flex items-center justify-between h-16 responsive-container">
              ...
              >
                ...
                <div className="hidden sm:block responsive-container">
                  ...
                  <p className="text-xs text-slate-500 -mt-1 hidden lg:block responsive-container">
                  ...
                  <div key={item.id} className="relative responsive-container">
                    ...
                    >
                      {React.createElement(
                        ...
                        { className: 'w-4 h-4 responsive-container' }
                      )}
                      <span className="text-sm xl:text-base responsive-container">
                        {item.label}
                      </span>
                      {!item.href && (
                        <ChevronDown
              ...
              <div className="flex items-center space-x-2 responsive-container">
                ...
                >
                  {isMenuOpen ? (
                    <X className="w-6 h-6 responsive-container" />
                  ) : (
                    <Menu className="w-6 h-6 responsive-container" />
                  )}
                </button>
              </div>
            </div>
                ...
                <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8 responsive-container">
                      ...
                      .map((section, index) => (
                        ...
                        >
                          ...
                          <div className="text-center mb-8 responsive-container">
                            <h2 className="text-3xl font-bold text-slate-900 mb-2 responsive-container">
                              {section.title}
                            </h2>
                            <p className="text-slate-600 max-w-2xl mx-auto responsive-container">
                              {section.title === 'Solutions' &&
                                'Complete transportation and logistics solutions powered by AI'}
                              {section.title === 'AI Agents' &&
                                'Intelligent AI agents that automate and optimize your operations'}
                              {section.title === 'Technology' &&
                                'Cutting-edge technology stack powering our logistics platform'}
                              {section.title === 'Company' &&
                                'Learn more about Trans Bot AI and our mission'}
                              {section.title === 'Resources' &&
                                'Knowledge base, support, and learning resources'}
                            </p>
                          </div>
                          ...
                          {section.featured && (
                            <div className="mb-12 responsive-container">
                              <h3 className="text-xl font-semibold text-slate-800 mb-4 responsive-container">
                                Featured Solution
                              </h3>
                                ...
                                >
                                  <div className="flex items-center space-x-6 responsive-container">
                                    <div className="w-16 h-16 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-600 rounded-2xl flex items-center justify-center shadow-lg responsive-container">
                                      {React.createElement(
                                        item.icon as React.ComponentType<{ className?: string }>,
                                        { className: 'w-8 h-8 text-white responsive-container' }
                                      )}
                                    </div>
                                    <div className="flex-1 responsive-container">
                                      <h4 className="text-2xl font-bold text-slate-900 mb-2 responsive-container">
                                        {item.label}
                                      </h4>
                                      <p className="text-lg text-slate-700 mb-4 responsive-container">
                                        {item.description}
                                      </p>
                            ...
                            <div className="space-y-8 responsive-container">
                              ...
                              <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100 p-6 rounded-2xl border border-blue-200 responsive-container">
                                <div className="flex items-center mb-6 responsive-container">
                                  ...
                                  <div>
                                    <h3 className="text-xl font-bold text-blue-900 responsive-container">
                                      Core Technologies
                                    </h3>
                                    <p className="text-blue-700 text-sm responsive-container">
                                      ...
                                      <div className="flex items-center space-x-3 responsive-container">
                                        <div className="w-10 h-10 bg-gradient-to-br from-blue-100 to-blue-200 group-hover:from-blue-200 group-hover:to-blue-300 rounded-lg flex items-center justify-center transition-all duration-300 responsive-container">
                                          {React.createElement(
                                            ...
                                            {
                                              className:
                                                'w-5 h-5 text-blue-600 responsive-container',
                                            }
                                          )}
                                        </div>
                                        <div className="flex-1 responsive-container">
                              ...
                              <div className="bg-gradient-to-br from-purple-50 via-pink-50 to-purple-100 p-6 rounded-2xl border border-purple-200 responsive-container">
                                <div className="flex items-center mb-6 responsive-container">
                                  ...
                                  <div>
                                    <h3 className="text-xl font-bold text-purple-900 responsive-container">
                                      Advanced Technologies
                                    </h3>
                                    <p className="text-purple-700 text-sm responsive-container">
                                      ...
                                      <div className="flex items-center space-x-3 responsive-container">
                                        <div className="w-10 h-10 bg-gradient-to-br from-purple-100 to-purple-200 group-hover:from-purple-200 group-hover:to-purple-300 rounded-lg flex items-center justify-center transition-all duration-300 responsive-container">
                                          {React.createElement(
                                            ...
                                            {
                                              className:
                                                'w-5 h-5 text-purple-600 responsive-container',
                                            }
                                          )}
                                        </div>
                                        <div className="flex-1 responsive-container">
                                    ...
                                    <div className="flex flex-col items-center text-center space-y-4 responsive-container">
                                      <div className="w-12 h-12 bg-gradient-to-br from-slate-100 to-slate-200 group-hover:from-blue-100 group-hover:to-purple-100 rounded-xl flex items-center justify-center transition-all duration-300 responsive-container">
                                        {React.createElement(
                                          ...
                                          {
                                            className:
                                              'w-6 h-6 text-slate-600 group-hover:text-blue-600 transition-colors responsive-container',
                                          }
                                        )}
                                      </div>
                                      <div>
                  ...
                  >
                    <div className="flex items-center justify-between responsive-container">
                      <div>
                        <h4 className="text-lg font-semibold text-slate-900 responsive-container">
                  ...
                  <nav className="space-y-4 responsive-container">
                    {mainMenuItems.map(item => (
                      ...
                      >
                        {React.createElement(
                          item.icon as React.ComponentType<{ className?: string }>,
                          { className: 'w-5 h-5 text-slate-400 responsive-container' }
                        )}
                        <span className="font-medium text-slate-900 responsive-container">
                          {item.label}
                        </span>
                      </button>
                    ))}
