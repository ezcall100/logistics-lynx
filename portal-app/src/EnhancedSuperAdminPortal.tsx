        ...
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center space-x-4">
            <button
              ...
              className="p-2 text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-xl transition-all duration-200 border border-gray-200"
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900" style={{ color: '#1f2937' }}>Trans Bot AI</h1>
                <p className="text-sm text-gray-500 font-medium" style={{ color: '#6b7280' }}>Super Admin Portal</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              onClick={onLogout}
              className="bg-red-600 text-white px-4 py-2 rounded-xl hover:bg-red-700 transition-colors flex items-center space-x-2 shadow-lg"
            >
