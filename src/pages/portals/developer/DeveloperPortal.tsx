...
function DeveloperPortal() {
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with developer #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
          ...
          subSubMenus: [
            {
              ...
              path: '/developers/list/active',
            },
            {
              id: 'inactive-developers',
              label: 'Inactive Developers',
              path: '/developers/list/inactive',
            },
            {
              id: 'pending-developers',
              label: 'Pending Developers',
              path: '/developers/list/pending',
            },
          ],
        },
        {
          ...
          subSubMenus: [
            { id: 'add-developer', label: 'Add New Developer', path: '/developers/actions/add' },
            {
              id: 'import-developers',
              label: 'Import Developers',
              path: '/developers/actions/import',
            },
            {
              id: 'export-developers',
              label: 'Export Developers',
              path: '/developers/actions/export',
            },
          ],
        },
        {
          ...
          label: 'Verification',
          icon: UserCheck,
          path: '/developers/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/developers/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/developers/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/developers/verification/address',
            },
          ],
        },
      ],
      ...
      subMenus: [
        {
          ...
          icon: Users,
          path: '/analytics/developers',
          subSubMenus: [
            {
              id: 'developer-behavior',
              label: 'Developer Behavior',
              path: '/analytics/developers/behavior',
            },
            {
              id: 'developer-segments',
              label: 'Developer Segments',
              path: '/analytics/developers/segments',
            },
            {
              id: 'developer-lifetime',
              label: 'Developer Lifetime Value',
              path: '/analytics/developers/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review developer feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    {
      id: 3,
      title: 'Update developer records',
      priority: 'low',
      due: 'Next week',
      completed: true,
    },
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Developer Call', time: '2:00 PM', date: 'Today', type: 'call' },
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Developer Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search developers, orders, reports..."
                  value={searchQuery}
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Developer Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Developer Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Developer Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
