...
function CustomerPortal() {
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with customer #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          path: '/customers/list',
          subSubMenus: [
            { id: 'active-customers', label: 'Active Customers', path: '/customers/list/active' },
            {
              id: 'inactive-customers',
              label: 'Inactive Customers',
              path: '/customers/list/inactive',
            },
            {
              id: 'pending-customers',
              label: 'Pending Customers',
              path: '/customers/list/pending',
            },
          ],
        },
        {
          ...
          subSubMenus: [
            { id: 'add-customer', label: 'Add New Customer', path: '/customers/actions/add' },
            {
              id: 'import-customers',
              label: 'Import Customers',
              path: '/customers/actions/import',
            },
            {
              id: 'export-customers',
              label: 'Export Customers',
              path: '/customers/actions/export',
            },
          ],
        },
        {
          ...
          subSubMenus: [
            {
              ...
              path: '/customers/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/customers/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/customers/verification/address',
            },
          ],
        },
      ],
          ...
          subSubMenus: [
            {
              ...
              path: '/analytics/customers/behavior',
            },
            {
              id: 'customer-segments',
              label: 'Customer Segments',
              path: '/analytics/customers/segments',
            },
            {
              id: 'customer-lifetime',
              label: 'Customer Lifetime Value',
              path: '/analytics/customers/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    { id: 3, title: 'Update customer records', priority: 'low', due: 'Next week', completed: true },
  ];
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Customer Call', time: '2:00 PM', date: 'Today', type: 'call' },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      {/* Enhanced Header - Responsive */}
      <header className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-lg shadow-lg border-b border-gray-200 dark:border-slate-700/50 dark:border-slate-700/50 dark:border-slate-700/50 sticky top-0 z-40">
      ...
      <div className="flex relative">
        ...
        <aside
          className={`${sidebarCollapsed ? 'w-16' : 'w-64 lg:w-72'} bg-white/90 dark:bg-slate-800/90 backdrop-blur-lg shadow-xl border-r border-gray-200 dark:border-slate-700/50 dark:border-slate-700/50 dark:border-slate-700/50 transition-all duration-300 ease-in-out sticky top-20 h-[calc(100vh-5rem)] z-30 hidden md:block`}
        >
        ...
        {!sidebarCollapsed && (
          <div className="md:hidden fixed inset-0 z-50">
            ...
            />
            {/* Mobile Sidebar */}
            <aside className="absolute left-0 top-0 w-80 h-full bg-white/95 dark:bg-slate-800/95 backdrop-blur-lg shadow-2xl border-r border-gray-200 dark:border-slate-700/50 dark:border-slate-700/50 dark:border-slate-700/50">
              <div className="flex flex-col h-full">
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          ...
          <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-lg rounded-2xl p-4 sm:p-6 shadow-lg border border-gray-200 dark:border-slate-700/50 dark:border-slate-700/50 dark:border-slate-700/50">
