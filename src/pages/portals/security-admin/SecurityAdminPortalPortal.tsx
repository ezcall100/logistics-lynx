...
const SecurityAdminPortal: React.FC = () => {
                ...
                <div className="p-6 border-b border-white/20">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h2 className="text-xl font-bold text-white">Security Admin Portal</h2>
        ...
        <div className="flex-1 flex flex-col min-w-0">
            ...
            <div className="px-6 py-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h1 className="text-2xl font-bold text-white">Security Admin Portal</h1>
          ...
          <div className="flex-1 overflow-y-auto p-6">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="mb-8">
                <RealTimePortalStatus portalId="security-admin" />
              </div>
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="mt-8 p-6 bg-white/5 backdrop-blur-xl rounded-xl border border-white/10">
                        <div className="text-white/70">
                          <p className="mb-4">
                            Welcome to the Security Admin Portal with enterprise-grade features:
                          </p>
