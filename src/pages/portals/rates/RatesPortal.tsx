...
function RatesPortal() {
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with rates #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
  ...
  const menuItems = [
      ...
      subMenus: [
        {
          ...
          path: '/ratess/list',
          subSubMenus: [
            { id: 'active-ratess', label: 'Active Ratess', path: '/ratess/list/active' },
            { id: 'inactive-ratess', label: 'Inactive Ratess', path: '/ratess/list/inactive' },
            { id: 'pending-ratess', label: 'Pending Ratess', path: '/ratess/list/pending' },
          ],
        },
        {
          id: 'rates-actions',
          ...
          path: '/ratess/actions',
          subSubMenus: [
            { id: 'add-rates', label: 'Add New Rates', path: '/ratess/actions/add' },
            { id: 'import-ratess', label: 'Import Ratess', path: '/ratess/actions/import' },
            { id: 'export-ratess', label: 'Export Ratess', path: '/ratess/actions/export' },
          ],
        },
        {
          id: 'rates-verification',
          label: 'Verification',
          icon: UserCheck,
          path: '/ratess/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/ratess/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/ratess/verification/documents',
            },
            { id: 'verify-address', label: 'Verify Address', path: '/ratess/verification/address' },
          ],
        },
      ],
    },
    ...
    },
    {
      ...
      subMenus: [
        {
          id: 'rates-analytics',
          label: 'Rates Analytics',
          icon: Users,
          path: '/analytics/ratess',
          subSubMenus: [
            { id: 'rates-behavior', label: 'Rates Behavior', path: '/analytics/ratess/behavior' },
            { id: 'rates-segments', label: 'Rates Segments', path: '/analytics/ratess/segments' },
            {
              id: 'rates-lifetime',
              label: 'Rates Lifetime Value',
              path: '/analytics/ratess/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review rates feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    { id: 3, title: 'Update rates records', priority: 'low', due: 'Next week', completed: true },
  ];
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Rates Call', time: '2:00 PM', date: 'Today', type: 'call' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Rates Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search ratess, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Rates Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="rates" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Rates Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Rates Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
