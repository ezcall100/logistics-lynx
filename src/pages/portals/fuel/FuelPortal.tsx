...
function FuelPortal() {
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with fuel #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          path: '/fuels/list',
          subSubMenus: [
            { id: 'active-fuels', label: 'Active Fuels', path: '/fuels/list/active' },
            { id: 'inactive-fuels', label: 'Inactive Fuels', path: '/fuels/list/inactive' },
            { id: 'pending-fuels', label: 'Pending Fuels', path: '/fuels/list/pending' },
          ],
        },
        {
          id: 'fuel-actions',
          ...
          path: '/fuels/actions',
          subSubMenus: [
            { id: 'add-fuel', label: 'Add New Fuel', path: '/fuels/actions/add' },
            { id: 'import-fuels', label: 'Import Fuels', path: '/fuels/actions/import' },
            { id: 'export-fuels', label: 'Export Fuels', path: '/fuels/actions/export' },
          ],
        },
        {
          ...
          label: 'Verification',
          icon: UserCheck,
          path: '/fuels/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/fuels/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/fuels/verification/documents',
            },
            { id: 'verify-address', label: 'Verify Address', path: '/fuels/verification/address' },
          ],
        },
      ],
    },
      ...
      subMenus: [
        {
          ...
          icon: Users,
          path: '/analytics/fuels',
          subSubMenus: [
            { id: 'fuel-behavior', label: 'Fuel Behavior', path: '/analytics/fuels/behavior' },
            { id: 'fuel-segments', label: 'Fuel Segments', path: '/analytics/fuels/segments' },
            {
              id: 'fuel-lifetime',
              label: 'Fuel Lifetime Value',
              path: '/analytics/fuels/lifetime',
            },
          ],
        },
        {
  ...
  const emailList = [
    { id: 1, from: 'fuel@example.com', subject: 'Order Inquiry', time: '1 hour ago', unread: true },
    {
      id: 2,
  ...
  const tasks = [
    ...
    { id: 2, title: 'Review fuel feedback', priority: 'medium', due: 'Tomorrow', completed: false },
    { id: 3, title: 'Update fuel records', priority: 'low', due: 'Next week', completed: true },
  ];
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Fuel Call', time: '2:00 PM', date: 'Today', type: 'call' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Fuel Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search fuels, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Fuel Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="fuel" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Fuel Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Fuel Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
