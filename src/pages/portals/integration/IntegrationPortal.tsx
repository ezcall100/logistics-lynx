...
function IntegrationPortal() {
  ...
  const notifications = [
    {
      id: 1,
      title: 'New integration registered',
  ...
  const performanceData = [
    {
      label: 'Integration Satisfaction',
      value: 92,
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with integration #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
    ...
    },
    {
      ...
      subMenus: [
        ...
        },
        {
          ...
          label: 'Verification',
          icon: UserCheck,
          path: '/integrations/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/integrations/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/integrations/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/integrations/verification/address',
            },
          ],
        },
      ],
      ...
      subMenus: [
        {
          ...
          subSubMenus: [
            {
              id: 'integration-behavior',
              label: 'Integration Behavior',
              path: '/analytics/integrations/behavior',
            },
            {
              id: 'integration-segments',
              label: 'Integration Segments',
              path: '/analytics/integrations/segments',
            },
            {
              id: 'integration-lifetime',
              label: 'Integration Lifetime Value',
              path: '/analytics/integrations/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review integration feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    {
      id: 3,
      title: 'Update integration records',
      priority: 'low',
      due: 'Next week',
      completed: true,
    },
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Integration Call', time: '2:00 PM', date: 'Today', type: 'call' },
  ...
  const notes = [
    {
      id: 1,
      title: 'Integration Meeting Notes',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Integration Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search integrations, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Integration Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="integration" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Integration Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Integration Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
