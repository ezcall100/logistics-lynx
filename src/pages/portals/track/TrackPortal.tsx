...
function TrackPortal() {
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with track #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          path: '/tracks/list',
          subSubMenus: [
            { id: 'active-tracks', label: 'Active Tracks', path: '/tracks/list/active' },
            { id: 'inactive-tracks', label: 'Inactive Tracks', path: '/tracks/list/inactive' },
            { id: 'pending-tracks', label: 'Pending Tracks', path: '/tracks/list/pending' },
          ],
        },
        {
          id: 'track-actions',
          ...
          path: '/tracks/actions',
          subSubMenus: [
            { id: 'add-track', label: 'Add New Track', path: '/tracks/actions/add' },
            { id: 'import-tracks', label: 'Import Tracks', path: '/tracks/actions/import' },
            { id: 'export-tracks', label: 'Export Tracks', path: '/tracks/actions/export' },
          ],
        },
        {
          ...
          label: 'Verification',
          icon: UserCheck,
          path: '/tracks/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/tracks/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/tracks/verification/documents',
            },
            { id: 'verify-address', label: 'Verify Address', path: '/tracks/verification/address' },
          ],
        },
      ],
    },
      ...
      subMenus: [
        {
          ...
          subSubMenus: [
            { id: 'track-behavior', label: 'Track Behavior', path: '/analytics/tracks/behavior' },
            { id: 'track-segments', label: 'Track Segments', path: '/analytics/tracks/segments' },
            {
              id: 'track-lifetime',
              label: 'Track Lifetime Value',
              path: '/analytics/tracks/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review track feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    { id: 3, title: 'Update track records', priority: 'low', due: 'Next week', completed: true },
  ];
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Track Call', time: '2:00 PM', date: 'Today', type: 'call' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Track Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search tracks, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Track Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="track" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Track Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Track Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
