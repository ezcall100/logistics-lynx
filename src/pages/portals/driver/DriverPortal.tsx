...
function DriverPortal() {
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with driver #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          path: '/drivers/list',
          subSubMenus: [
            { id: 'active-drivers', label: 'Active Drivers', path: '/drivers/list/active' },
            { id: 'inactive-drivers', label: 'Inactive Drivers', path: '/drivers/list/inactive' },
            { id: 'pending-drivers', label: 'Pending Drivers', path: '/drivers/list/pending' },
          ],
        },
        {
          id: 'driver-actions',
          ...
          icon: UserPlus,
          path: '/drivers/actions',
          subSubMenus: [
            { id: 'add-driver', label: 'Add New Driver', path: '/drivers/actions/add' },
            { id: 'import-drivers', label: 'Import Drivers', path: '/drivers/actions/import' },
            { id: 'export-drivers', label: 'Export Drivers', path: '/drivers/actions/export' },
          ],
        },
        {
          ...
          subSubMenus: [
            {
              ...
              path: '/drivers/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/drivers/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/drivers/verification/address',
            },
          ],
        },
      ],
          ...
          subSubMenus: [
            {
              ...
              path: '/analytics/drivers/behavior',
            },
            {
              id: 'driver-segments',
              label: 'Driver Segments',
              path: '/analytics/drivers/segments',
            },
            {
              id: 'driver-lifetime',
              label: 'Driver Lifetime Value',
              path: '/analytics/drivers/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review driver feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    { id: 3, title: 'Update driver records', priority: 'low', due: 'Next week', completed: true },
  ];
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Driver Call', time: '2:00 PM', date: 'Today', type: 'call' },
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Driver Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search drivers, orders, reports..."
                  value={searchQuery}
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Driver Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Driver Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
