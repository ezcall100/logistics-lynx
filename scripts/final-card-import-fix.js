...
console.log('🔧 FINAL CARD IMPORT FIX');
console.log('Fixing remaining unterminated string literals in card component imports...\n');

const patterns = [
  // Fix unterminated string literals in card component imports: } from '@/components/ui/card => } from '@/components/ui/card'
  {
    name: 'Fix unterminated string literals in card component imports',
    regex: /}\s+from\s+'@\/components\/ui\/card\s*$/gm,
...
try {
  ...
  console.log(`\n🔧 Final card import fix complete! Fixed ${fixedCount} files.`);
  console.log('\n🧹 Next steps:');
