...
function TrackTracePortal() {
  ...
  const notifications = [
    {
      id: 1,
      title: 'New track&trace registered',
    ...
    {
      id: 2,
      title: 'Track&Trace status updated',
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400">Track&Trace Management</p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-slate-600 dark:text-slate-400 mt-1">
                    Welcome back, {user.name}! Here's what's happening with your Track&Trace Management.
                  </p>
                </div>
                <div className="flex items-center space-x-2">
