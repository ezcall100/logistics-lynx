...
function ReportingPortal() {
  ...
  const notifications = [
    {
      id: 1,
      title: 'New reporting registered',
    ...
    {
      id: 2,
      title: 'Reporting status updated',
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with reporting #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
  ...
  const menuItems = [
    ...
    },
    {
      ...
      subMenus: [
        {
          id: 'reporting-list',
          label: 'Reporting List',
          icon: Users,
          path: '/reportings/list',
          subSubMenus: [
            {
              id: 'active-reportings',
              label: 'Active Reportings',
              path: '/reportings/list/active',
            },
            {
              id: 'inactive-reportings',
              label: 'Inactive Reportings',
              path: '/reportings/list/inactive',
            },
            {
              id: 'pending-reportings',
              label: 'Pending Reportings',
              path: '/reportings/list/pending',
            },
          ],
        },
        {
          id: 'reporting-actions',
          label: 'Reporting Actions',
          icon: UserPlus,
          path: '/reportings/actions',
          subSubMenus: [
            { id: 'add-reporting', label: 'Add New Reporting', path: '/reportings/actions/add' },
            {
              id: 'import-reportings',
              label: 'Import Reportings',
              path: '/reportings/actions/import',
            },
            {
              id: 'export-reportings',
              label: 'Export Reportings',
              path: '/reportings/actions/export',
            },
          ],
        },
        {
          ...
          label: 'Verification',
          icon: UserCheck,
          path: '/reportings/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/reportings/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/reportings/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/reportings/verification/address',
            },
          ],
        },
      ],
      ...
      subMenus: [
        {
          ...
          icon: Users,
          path: '/analytics/reportings',
          subSubMenus: [
            {
              id: 'reporting-behavior',
              label: 'Reporting Behavior',
              path: '/analytics/reportings/behavior',
            },
            {
              id: 'reporting-segments',
              label: 'Reporting Segments',
              path: '/analytics/reportings/segments',
            },
            {
              id: 'reporting-lifetime',
              label: 'Reporting Lifetime Value',
              path: '/analytics/reportings/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review reporting feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    {
      id: 3,
      title: 'Update reporting records',
      priority: 'low',
      due: 'Next week',
      completed: true,
    },
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Reporting Call', time: '2:00 PM', date: 'Today', type: 'call' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Reporting Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search reportings, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Reporting Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="reporting" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Reporting Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Reporting Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
