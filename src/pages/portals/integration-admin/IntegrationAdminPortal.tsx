...
function IntegrationAdminPortal() {
  const [user] = useState({
    id: 1,
    name: 'Demo User',
  ...
  const notifications = [
    {
      id: 1,
      title: 'New integrationadmin registered',
    ...
    {
      id: 2,
      title: 'IntegrationAdmin status updated',
  ...
  const metrics = [
    {
      id: 'active',
      title: 'Active IntegrationAdmins',
      value: '128',
      change: '+12%',
      changeType: 'increase',
      icon: Activity,
  ...
  const performanceData = [
    {
      label: 'IntegrationAdmin Satisfaction',
      value: 92,
  ...
  const recentActivity = [
    {
      id: 1,
      action: 'New integrationadmin created',
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with integrationadmin #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
  ...
  const menuItems = [
    ...
    {
      id: 'integrationadmin-management',
      label: 'IntegrationAdmin Management',
      icon: Users,
      color: 'text-emerald-600',
      path: '/integrationadmins',
      subMenus: [
        {
          id: 'integrationadmin-list',
          label: 'IntegrationAdmin List',
          icon: Users,
          path: '/integrationadmins/list',
          subSubMenus: [
            {
              id: 'active-integrationadmins',
              label: 'Active IntegrationAdmins',
              path: '/integrationadmins/list/active',
            },
            {
              id: 'inactive-integrationadmins',
              label: 'Inactive IntegrationAdmins',
              path: '/integrationadmins/list/inactive',
            },
            {
              id: 'pending-integrationadmins',
              label: 'Pending IntegrationAdmins',
              path: '/integrationadmins/list/pending',
            },
          ],
        },
        {
          id: 'integrationadmin-actions',
          label: 'IntegrationAdmin Actions',
          icon: UserPlus,
          path: '/integrationadmins/actions',
          subSubMenus: [
            {
              id: 'add-integrationadmin',
              label: 'Add New IntegrationAdmin',
              path: '/integrationadmins/actions/add',
            },
            {
              id: 'import-integrationadmins',
              label: 'Import IntegrationAdmins',
              path: '/integrationadmins/actions/import',
            },
            {
              id: 'export-integrationadmins',
              label: 'Export IntegrationAdmins',
              path: '/integrationadmins/actions/export',
            },
          ],
        },
        {
          id: 'integrationadmin-verification',
          label: 'Verification',
          icon: UserCheck,
          path: '/integrationadmins/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/integrationadmins/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/integrationadmins/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/integrationadmins/verification/address',
            },
          ],
        },
      ],
    ...
    },
    {
      ...
      subMenus: [
        {
          id: 'integrationadmin-analytics',
          label: 'IntegrationAdmin Analytics',
          icon: Users,
          path: '/analytics/integrationadmins',
          subSubMenus: [
            {
              id: 'integrationadmin-behavior',
              label: 'IntegrationAdmin Behavior',
              path: '/analytics/integrationadmins/behavior',
            },
            {
              id: 'integrationadmin-segments',
              label: 'IntegrationAdmin Segments',
              path: '/analytics/integrationadmins/segments',
            },
            {
              id: 'integrationadmin-lifetime',
              label: 'IntegrationAdmin Lifetime Value',
              path: '/analytics/integrationadmins/lifetime',
            },
          ],
        },
        {
  ...
  const emailList = [
    {
      id: 1,
      from: 'integrationadmin@example.com',
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review integrationadmin feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
    {
      id: 3,
      title: 'Update integrationadmin records',
      priority: 'low',
      due: 'Next week',
      completed: true,
    },
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'IntegrationAdmin Call', time: '2:00 PM', date: 'Today', type: 'call' },
  ...
  const notes = [
    {
      id: 1,
      title: 'IntegrationAdmin Meeting Notes',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search integrationadmins, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="integrationadmin" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Integration Admin
                  Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Integration Admin Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
...
export default IntegrationAdminPortal;
