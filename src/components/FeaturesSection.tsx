            ...
            >
              ...
              <div className={`${index % 2 === 1 ? 'lg:col-start-2' : ''}`}>
                <div className="bg-red-50 border border-red-200 rounded-2xl p-8">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">{item.problem}</h3>
              ...
              <div className={`${index % 2 === 1 ? 'lg:col-start-1' : ''}`}>
                <div className="bg-gradient-to-br from-blue-50 to-purple-50 border border-blue-200 rounded-2xl p-8">
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-gray-900">{item.solution}</h3>
                      <div
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {innovations.map((innovation, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              whileHover={{ y: -5 }}
              className="group p-6 rounded-xl bg-gradient-to-br from-gray-50 to-white border border-gray-200 hover:border-blue-300 hover:shadow-lg transition-all duration-300"
            >
              <div
