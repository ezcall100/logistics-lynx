...
function EDIPortal() {
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with edi #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          path: '/edis/list',
          subSubMenus: [
            { id: 'active-edis', label: 'Active EDIs', path: '/edis/list/active' },
            { id: 'inactive-edis', label: 'Inactive EDIs', path: '/edis/list/inactive' },
            { id: 'pending-edis', label: 'Pending EDIs', path: '/edis/list/pending' },
          ],
        },
        {
          id: 'edi-actions',
          ...
          path: '/edis/actions',
          subSubMenus: [
            { id: 'add-edi', label: 'Add New EDI', path: '/edis/actions/add' },
            { id: 'import-edis', label: 'Import EDIs', path: '/edis/actions/import' },
            { id: 'export-edis', label: 'Export EDIs', path: '/edis/actions/export' },
          ],
        },
        {
          id: 'edi-verification',
          label: 'Verification',
          icon: UserCheck,
          path: '/edis/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/edis/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/edis/verification/documents',
            },
            { id: 'verify-address', label: 'Verify Address', path: '/edis/verification/address' },
          ],
        },
      ],
    },
      ...
      subMenus: [
        {
          ...
          path: '/analytics/edis',
          subSubMenus: [
            { id: 'edi-behavior', label: 'EDI Behavior', path: '/analytics/edis/behavior' },
            { id: 'edi-segments', label: 'EDI Segments', path: '/analytics/edis/segments' },
            { id: 'edi-lifetime', label: 'EDI Lifetime Value', path: '/analytics/edis/lifetime' },
          ],
        },
        {
  ...
  const emailList = [
    { id: 1, from: 'edi@example.com', subject: 'Order Inquiry', time: '1 hour ago', unread: true },
    {
      id: 2,
  ...
  const tasks = [
    ...
    { id: 2, title: 'Review edi feedback', priority: 'medium', due: 'Tomorrow', completed: false },
    { id: 3, title: 'Update edi records', priority: 'low', due: 'Next week', completed: true },
  ];
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'EDI Call', time: '2:00 PM', date: 'Today', type: 'call' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">EDI Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search edis, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">EDI Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="edi" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your EDI Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
            ...
            <div className="bg-white/70 backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-gray-200/50">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Key performance indicators for EDI Portal</p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
