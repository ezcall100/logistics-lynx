...
console.log('🔧 FINAL RELATIVE IMPORT FIX');
console.log('Fixing remaining unterminated string literals in relative imports...\n');

const patterns = [
  // Fix unterminated string literals in relative imports: } from '../../../components/ui => } from '../../../components/ui'
  {
    name: 'Fix unterminated string literals in relative imports',
...
try {
  ...
  console.log(`\n🔧 Final relative import fix complete! Fixed ${fixedCount} files.`);
  console.log('\n🧹 Next steps:');
