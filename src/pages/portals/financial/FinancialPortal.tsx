...
function FinancialPortal() {
  ...
  const notifications = [
    {
      id: 1,
      title: 'New financial registered',
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with financial #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
  ...
  const menuItems = [
    ...
    },
    {
      ...
      subMenus: [
        {
          id: 'financial-list',
          label: 'Financial List',
          icon: Users,
          path: '/financials/list',
          subSubMenus: [
            {
              id: 'active-financials',
              label: 'Active Financials',
              path: '/financials/list/active',
            },
            {
              id: 'inactive-financials',
              label: 'Inactive Financials',
              path: '/financials/list/inactive',
            },
            {
              id: 'pending-financials',
              label: 'Pending Financials',
              path: '/financials/list/pending',
            },
          ],
        },
        {
          ...
          subSubMenus: [
            { id: 'add-financial', label: 'Add New Financial', path: '/financials/actions/add' },
            {
              id: 'import-financials',
              label: 'Import Financials',
              path: '/financials/actions/import',
            },
            {
              id: 'export-financials',
              label: 'Export Financials',
              path: '/financials/actions/export',
            },
          ],
        },
        {
          ...
          label: 'Verification',
          icon: UserCheck,
          path: '/financials/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/financials/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/financials/verification/documents',
            },
            {
              id: 'verify-address',
              label: 'Verify Address',
              path: '/financials/verification/address',
            },
          ],
        },
      ],
          ...
          subSubMenus: [
            {
              ...
              path: '/analytics/financials/behavior',
            },
            {
              id: 'financial-segments',
              label: 'Financial Segments',
              path: '/analytics/financials/segments',
            },
            {
              id: 'financial-lifetime',
              label: 'Financial Lifetime Value',
              path: '/analytics/financials/lifetime',
            },
          ],
        },
        {
  ...
  const tasks = [
    ...
    {
      id: 2,
      title: 'Review financial feedback',
      priority: 'medium',
      due: 'Tomorrow',
      completed: false,
    },
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'Financial Call', time: '2:00 PM', date: 'Today', type: 'call' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">Financial Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search financials, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Financial Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="financial" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your Financial Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Key performance indicators for Financial Portal
                  </p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
