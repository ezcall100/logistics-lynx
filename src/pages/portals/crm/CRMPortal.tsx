...
function CRMPortal() {
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      details: 'Mark Johnson is now active with crm #5678',
      time: '1 hour ago',
      type: 'success',
      icon: CheckCircle,
    },
      ...
      subMenus: [
        {
          ...
          path: '/crms/list',
          subSubMenus: [
            { id: 'active-crms', label: 'Active CRMs', path: '/crms/list/active' },
            { id: 'inactive-crms', label: 'Inactive CRMs', path: '/crms/list/inactive' },
            { id: 'pending-crms', label: 'Pending CRMs', path: '/crms/list/pending' },
          ],
        },
        {
          id: 'crm-actions',
          ...
          path: '/crms/actions',
          subSubMenus: [
            { id: 'add-crm', label: 'Add New CRM', path: '/crms/actions/add' },
            { id: 'import-crms', label: 'Import CRMs', path: '/crms/actions/import' },
            { id: 'export-crms', label: 'Export CRMs', path: '/crms/actions/export' },
          ],
        },
        {
          id: 'crm-verification',
          label: 'Verification',
          icon: UserCheck,
          path: '/crms/verification',
          subSubMenus: [
            {
              id: 'verify-identity',
              label: 'Verify Identity',
              path: '/crms/verification/identity',
            },
            {
              id: 'verify-documents',
              label: 'Verify Documents',
              path: '/crms/verification/documents',
            },
            { id: 'verify-address', label: 'Verify Address', path: '/crms/verification/address' },
          ],
        },
      ],
    },
      ...
      subMenus: [
        {
          ...
          path: '/analytics/crms',
          subSubMenus: [
            { id: 'crm-behavior', label: 'CRM Behavior', path: '/analytics/crms/behavior' },
            { id: 'crm-segments', label: 'CRM Segments', path: '/analytics/crms/segments' },
            { id: 'crm-lifetime', label: 'CRM Lifetime Value', path: '/analytics/crms/lifetime' },
          ],
        },
        {
  ...
  const emailList = [
    { id: 1, from: 'crm@example.com', subject: 'Order Inquiry', time: '1 hour ago', unread: true },
    {
      id: 2,
  ...
  const tasks = [
    ...
    { id: 2, title: 'Review crm feedback', priority: 'medium', due: 'Tomorrow', completed: false },
    { id: 3, title: 'Update crm records', priority: 'low', due: 'Next week', completed: true },
  ];
  ...
  const calendarEvents = [
    ...
    { id: 2, title: 'CRM Call', time: '2:00 PM', date: 'Today', type: 'call' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-medium">CRM Portal</p>
                </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Search crms, orders, reports..."
                  value={searchQuery}
      ...
      <div className="flex relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">CRM Portal</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setSidebarCollapsed(true)}
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          {/* Real-time Status */}
          <RealTimePortalStatus portalId="crm" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Welcome back, {user.name}! Here's what's happening with your CRM Portal.
                </p>
              </div>
              <div className="flex items-center space-x-2">
            ...
            <div className="bg-white/70 backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-gray-200/50">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Key performance indicators for CRM Portal</p>
                </div>
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
