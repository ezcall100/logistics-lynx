...
export default function YMSPortal() {
  ...
  const stats = [
    {
      label: 'Total Yards',
      value: ymsStats.totalYards.toString(),
      icon: Building,
      color: 'text-blue-600',
      bgColor: 'bg-blue-50',
    },
    {
      ...
      value: ymsStats.activeVehicles.toString(),
      icon: Truck,
    ...
    {
      label: 'Avg Wait Time',
      value: `${ymsStats.averageWaitTime} min`,
      icon: Clock,
                  ...
                  <div key={activity.id} className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-600">
                        {activity.vehicle} • {activity.yard}
                      </p>
