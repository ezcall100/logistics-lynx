...
const SecurityPage: React.FC = () => {
  ...
  return (
    <ResponsiveContainer>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-red-50 py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16 bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Security Overview</h2>
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {securityPractices.map((practice, index) => (
                <div key={index} className="bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-shadow duration-300">
                  <h3 className="text-xl font-bold text-gray-900 mb-6">{practice.category}</h3>
          ...
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Compliance Frameworks</h2>
            <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="mt-16 bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">Security Contact</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Security Inquiries</h3>
                <div className="space-y-2">
                  <p className="text-gray-600">Email: security@transbotai.com</p>
                  <p className="text-gray-600">Phone: +1 (555) 123-4567</p>
                </div>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Compliance Questions</h3>
                <div className="space-y-2">
                  <p className="text-gray-600">Email: compliance@transbotai.com</p>
